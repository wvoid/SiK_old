...
_encryptReturn_sloc0_1_0:
	.ds 3
_packet_get_next_slen_1_161:
	.ds 2
_packet_get_next_c_2_177:
	.ds 1
...
_packet_get_next_PARM_2:
	.ds 2
_packet_set_max_xmit_max_1_194:
	.ds 1
_packet_set_serial_speed_speed_1_196:
	.ds 2
_packet_is_duplicate_PARM_2:
	.ds 2
_packet_is_duplicate_len_1_198:
	.ds 1
_packet_inject_buf_1_202:
	.ds 2
;--------------------------------------------------------
...
;slen                      Allocated with name '_packet_get_next_slen_1_161'
;c                         Allocated with name '_packet_get_next_c_2_177'
...
;	radio/packet.c:194: slen = last_sent_len;
	...
	movx	a,@dptr
	mov	r6,a
	mov	_packet_get_next_slen_1_161,r6
	mov	(_packet_get_next_slen_1_161 + 1),#0x00
...
;	radio/packet.c:202: if (max_xmit < slen) {
	...
	clr	c
	mov	a,r2
	subb	a,_packet_get_next_slen_1_161
	mov	a,r3
	subb	a,(_packet_get_next_slen_1_161 + 1)
	jnc	00104$
;	radio/packet.c:204: last_sent_len = slen - max_xmit;
	mov	r3,_packet_get_next_slen_1_161
	mov	dptr,#_last_sent_len
	mov	a,r3
	clr	c
	subb	a,r7
...
;	radio/packet.c:205: slen = encryptReturn(buf, last_sent, max_xmit);
	...
	mov	r3,dpl
	pop	ar7
	mov	_packet_get_next_slen_1_161,r3
	mov	(_packet_get_next_slen_1_161 + 1),#0x00
...
;	radio/packet.c:209: return slen;
	mov	r4,_packet_get_next_slen_1_161
	mov	dpl,r4
	ret
00104$:
...
;	radio/packet.c:219: slen = serial_read_available();
	push	ar7
	lcall	_serial_read_available
	mov	_packet_get_next_slen_1_161,dpl
	mov	(_packet_get_next_slen_1_161 + 1),dph
	pop	ar7
...
;	radio/packet.c:234: slen = max_xmit;
	mov	_packet_get_next_slen_1_161,r5
	mov	(_packet_get_next_slen_1_161 + 1),r6
00112$:
...
;	radio/packet.c:239: if (slen == 0) {
	mov	a,_packet_get_next_slen_1_161
	orl	a,(_packet_get_next_slen_1_161 + 1)
...
;	radio/packet.c:257: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_161,00252$
	clr	a
	cjne	a,(_packet_get_next_slen_1_161 + 1),00252$
	sjmp	00253$
00252$:
	sjmp	00123$
00253$:
...
;	radio/packet.c:274: if (slen < mav_pkt_len) {
	...
	mov	a,_packet_get_next_slen_1_161
	subb	a,r5
	mov	a,(_packet_get_next_slen_1_161 + 1)
	subb	a,r6
	jnc	00129$
...
;	radio/packet.c:294: register uint8_t c = serial_peekx(0);
	...
	push	ar7
	lcall	_serial_peekx
	mov	_packet_get_next_c_2_177,dpl
	pop	ar7
;	radio/packet.c:295: if (c == MAVLINK10_STX || c == MAVLINK20_STX) {
	mov	a,#0xFE
	cjne	a,_packet_get_next_c_2_177,00259$
	sjmp	00150$
00259$:
	mov	a,#0xFD
	cjne	a,_packet_get_next_c_2_177,00260$
	sjmp	00261$
00260$:
	ljmp	00151$
00261$:
...
;	radio/packet.c:296: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_161,00262$
	clr	a
	cjne	a,(_packet_get_next_slen_1_161 + 1),00262$
	sjmp	00263$
00262$:
	sjmp	00135$
00263$:
...
;	radio/packet.c:314: slen--;				
	dec	_packet_get_next_slen_1_161
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_161,00268$
	dec	(_packet_get_next_slen_1_161 + 1)
00268$:
...
;	radio/packet.c:321: if (c == MAVLINK20_STX) {
	mov	a,#0xFD
	cjne	a,_packet_get_next_c_2_177,00143$
...
;	radio/packet.c:350: slen--;
	dec	_packet_get_next_slen_1_161
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_161,00275$
	dec	(_packet_get_next_slen_1_161 + 1)
00275$:
	ljmp	00154$
00156$:
...
;------------------------------------------------------------
;max                       Allocated with name '_packet_set_max_xmit_max_1_194'
;------------------------------------------------------------
...
_packet_set_max_xmit:
	mov	a,dpl
	mov	dptr,#_packet_set_max_xmit_max_1_194
	movx	@dptr,a
...
;------------------------------------------------------------
;speed                     Allocated with name '_packet_set_serial_speed_speed_1_196'
;------------------------------------------------------------
...
_packet_set_serial_speed:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_packet_set_serial_speed_speed_1_196
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;len                       Allocated with name '_packet_is_duplicate_len_1_198'
;------------------------------------------------------------
...
_packet_is_duplicate:
	mov	a,dpl
	mov	dptr,#_packet_is_duplicate_len_1_198
	movx	@dptr,a
...
;------------------------------------------------------------
;buf                       Allocated with name '_packet_inject_buf_1_202'
;------------------------------------------------------------
...
_packet_inject:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_packet_inject_buf_1_202
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
