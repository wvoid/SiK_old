...
;i                         Allocated with name '_tdm_init_i_1_259'
;air_rate                  Allocated with name '_tdm_init_air_rate_1_259'
;window_width              Allocated with name '_tdm_init_window_width_1_259'
;------------------------------------------------------------
...
;	radio/tdm.c:1020: window_width = 3*(packet_latency+(max_data_packet_length*(uint32_t)ticks_per_byte));
	...
	mov	r6,b
	mov	r7,a
	mov	dptr,#_tdm_init_window_width_1_259
	mov	a,r4
	movx	@dptr,a
	mov	a,r5
	inc	dptr
