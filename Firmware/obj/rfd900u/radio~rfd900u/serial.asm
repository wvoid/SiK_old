...
_serial_write_buf_sloc0_1_0:
	.ds 1
_serial_write_space_ES_saved_1_189:
	.ds 1
_serial_read_ES_saved_1_194:
	.ds 1
_serial_peek_ES_saved_1_200:
	.ds 1
_serial_peekx_ES_saved_1_202:
	.ds 1
_serial_read_buf_sloc1_1_0:
	.ds 1
_serial_read_available_ES_saved_1_214:
	.ds 1
;--------------------------------------------------------
...
_rts_count:
	.ds 1
_serial_write_buf_buf_1_176:
	.ds 2
_serial_peekx_offset_1_201:
	.ds 2
_serial_read_buf_buf_1_203:
	.ds 2
_serial_device_set_speed_i_1_224:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;buf                       Allocated with name '_serial_write_buf_buf_1_176'
;------------------------------------------------------------
...
_serial_write_buf:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_write_buf_buf_1_176
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/serial.c:408: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_write_space_ES_saved_1_189,c
	clr	_ES0
...
;	radio/serial.c:410: ES0_RESTORE;
	mov	c,_serial_write_space_ES_saved_1_189
	mov	_ES0,c
...
;	radio/serial.c:433: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_ES_saved_1_194,c
	clr	_ES0
...
;	radio/serial.c:447: ES0_RESTORE;
	mov	c,_serial_read_ES_saved_1_194
	mov	_ES0,c
...
;	radio/serial.c:457: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peek_ES_saved_1_200,c
	clr	_ES0
...
;	radio/serial.c:459: ES0_RESTORE;
	mov	c,_serial_peek_ES_saved_1_200
	mov	_ES0,c
...
;------------------------------------------------------------
;offset                    Allocated with name '_serial_peekx_offset_1_201'
;c                         Allocated to registers r7 
;------------------------------------------------------------
...
_serial_peekx:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_peekx_offset_1_201
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	radio/serial.c:469: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peekx_ES_saved_1_202,c
	clr	_ES0
...
;	radio/serial.c:471: ES0_RESTORE;
	mov	c,_serial_peekx_ES_saved_1_202
	mov	_ES0,c
...
;buf                       Allocated with name '_serial_read_buf_buf_1_203'
;------------------------------------------------------------
...
_serial_read_buf:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_read_buf_buf_1_203
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/serial.c:525: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_available_ES_saved_1_214,c
	clr	_ES0
...
;	radio/serial.c:527: ES0_RESTORE;
	mov	c,_serial_read_available_ES_saved_1_214
	mov	_ES0,c
...
;------------------------------------------------------------
;space                     Allocated with name '_serial_read_space_space_1_216'
;------------------------------------------------------------
...
;------------------------------------------------------------
;i                         Allocated with name '_serial_device_valid_speed_i_1_220'
;num_rates                 Allocated with name '_serial_device_valid_speed_num_rates_1_220'
;speed                     Allocated to registers r7 
;------------------------------------------------------------
...
;------------------------------------------------------------
;speed                     Allocated to registers r7 
;i                         Allocated with name '_serial_device_set_speed_i_1_224'
;num_rates                 Allocated with name '_serial_device_set_speed_num_rates_1_224'
;------------------------------------------------------------
...
;	radio/serial.c:594: for (i = 0; i < num_rates; i++) {
	...
	sjmp	00107$
00115$:
	mov	dptr,#_serial_device_set_speed_i_1_224
	mov	a,r6
	movx	@dptr,a
