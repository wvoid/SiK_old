...
;array                     Allocated with name '_shuffle_array_1_137'
;i                         Allocated with name '_shuffle_i_1_138'
;j                         Allocated with name '_shuffle_j_2_139'
;t                         Allocated with name '_shuffle_t_2_139'
;------------------------------------------------------------
