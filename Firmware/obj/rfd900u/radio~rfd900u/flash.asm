...
00103$:
	push	psw
;	radio/flash.c:64: __pdata uint8_t	bank_state = PSBANK;
	mov	r7,_PSBANK
;	radio/flash.c:65: PSBANK = ((bank_state & 0x03) | 0x30); // Select Bank 3
	mov	a,#0x03
	anl	a,r7
	orl	a,#0x30
	mov	_PSBANK,a
...
;	radio/flash.c:71: PSCTL = FLASH_DISABLE;			// disable flash write & scratch access
	mov	_PSCTL,#0x00
;	radio/flash.c:74: PSBANK = bank_state;
	mov	_PSBANK,r7
	pop	psw
	mov	ea,c
	ret
...
;------------------------------------------------------------
;d                         Allocated with name '_flash_read_scratch_d_1_135'
;------------------------------------------------------------
...
00103$:
	...
	mov	r6,dpl
	mov	r7,dph
;	radio/flash.c:84: __pdata uint8_t	bank_state = PSBANK;
	mov	r5,_PSBANK
;	radio/flash.c:85: PSBANK = ((bank_state & 0x03) | 0x30); // Select Bank 3
	mov	a,#0x03
	anl	a,r5
	orl	a,#0x30
	mov	_PSBANK,a
...
;	radio/flash.c:90: PSCTL = FLASH_DISABLE;
	mov	_PSCTL,#0x00
;	radio/flash.c:93: PSBANK = bank_state;
	mov	_PSBANK,r5
...
00103$:
	...
	mov	r6,dpl
	mov	r7,dph
;	radio/flash.c:102: __pdata uint8_t	bank_state = PSBANK;
	mov	r5,_PSBANK
;	radio/flash.c:103: PSBANK = ((bank_state & 0x03) | 0x30); // Select Bank 3
	mov	a,#0x03
	anl	a,r5
	orl	a,#0x30
	mov	_PSBANK,a
...
;	radio/flash.c:108: *(uint8_t __xdata *)(FLASH_SCRATCH | address) = c;
	...
	movx	a,@r0
	movx	@dptr,a
;	radio/flash.c:111: PSBANK = bank_state;
	mov	_PSBANK,r5
