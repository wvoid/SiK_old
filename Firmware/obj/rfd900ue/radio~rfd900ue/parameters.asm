...
;--------------------------------------------------------
	...
	.globl _param_set_default_encryption_key
	.globl _convert_to_hex
	.globl _read_hex_nibble
	.globl _write_params
	.globl _read_params
	.globl _crc16
	...
	.globl _param_name
	.globl _constrain
	.globl _param_set_encryption_key
	.globl _print_encryption_key
...
_param_check_PARM_2:
	.ds 4
_read_params_input_1_146:
	.ds 2
_write_params_input_1_148:
	.ds 2
_write_params_sloc0_1_0:
	.ds 2
_convert_to_hex_sloc0_1_0:
	.ds 2
_param_set_encryption_key_sloc0_1_0:
	.ds 2
;--------------------------------------------------------
...
_constrain_PARM_3:
	.ds 4
_convert_to_hex_PARM_3:
	.ds 1
_convert_to_hex_i_1_175:
	.ds 1
;--------------------------------------------------------
; external ram data
;--------------------------------------------------------
...
_write_params_PARM_3:
	.ds 1
_convert_to_hex_PARM_2:
	.ds 2
_convert_to_hex_str_in_1_174:
	.ds 2
_param_set_default_encryption_key_b_1_178:
	.ds 1
_param_set_encryption_key_key_1_180:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;input                     Allocated with name '_read_params_input_1_146'
;start                     Allocated with name '_read_params_PARM_2'
;size                      Allocated with name '_read_params_PARM_3'
;i                         Allocated with name '_read_params_i_1_147'
;------------------------------------------------------------
...
;	-----------------------------------------
_read_params:
	mov	_read_params_input_1_146,dpl
	mov	(_read_params_input_1_146 + 1),dph
...
;	radio/parameters.c:242: input[i-start] = flash_read_scratch(i);
	...
	mov	r7,a
	mov	a,r6
	add	a,_read_params_input_1_146
	mov	r6,a
	mov	a,r7
	addc	a,(_read_params_input_1_146 + 1)
	mov	r7,a
	mov	dpl,r1
	mov	dph,r2
	push	ar7
...
;	radio/parameters.c:245: if (crc16(size, input) != ((uint16_t) flash_read_scratch(i+1)<<8 | flash_read_scratch(i)))
	mov	_crc16_PARM_2,_read_params_input_1_146
	mov	(_crc16_PARM_2 + 1),(_read_params_input_1_146 + 1)
	mov	dpl,r3
	push	ar2
	push	ar1
	lcall	_crc16
...
;------------------------------------------------------------
;input                     Allocated with name '_write_params_input_1_148'
...
;i                         Allocated with name '_write_params_i_1_149'
;checksum                  Allocated with name '_write_params_checksum_1_149'
;------------------------------------------------------------
...
;	-----------------------------------------
_write_params:
	mov	_write_params_input_1_148,dpl
	mov	(_write_params_input_1_148 + 1),dph
...
;	radio/parameters.c:256: flash_write_scratch(i, input[i-start]);
	...
	mov	r7,a
	mov	a,r6
	add	a,_write_params_input_1_148
	mov	dpl,a
	mov	a,r7
	addc	a,(_write_params_input_1_148 + 1)
	mov	dph,a
...
;	radio/parameters.c:259: checksum = crc16(size, input);
	mov	_crc16_PARM_2,_write_params_input_1_148
	mov	(_crc16_PARM_2 + 1),(_write_params_input_1_148 + 1)
	mov	dpl,r3
	lcall	_crc16
	mov	r6,dpl
	mov	r7,dph
...
00146$:
	jc	00113$
;	radio/parameters.c:301: if(!read_params((__xdata uint8_t *)encryption_key, PARAM_E_FLASH_START+1, sizeof(encryption_key)))
	mov	dptr,#_read_params_PARM_2
	mov	a,#0x81
	movx	@dptr,a
	mov	a,#0x01
	...
	mov	a,#0x20
	movx	@dptr,a
	mov	dptr,#_encryption_key
	lcall	_read_params
;	radio/parameters.c:302: return false;
	jc	00112$
	sjmp	00115$
00112$:
...
;	radio/parameters.c:321: write_params((__xdata uint8_t *)parameter_values, PARAM_FLASH_START+1, sizeof(parameter_values));
	...
	mov	dptr,#_parameter_values
	lcall	_write_params
;	radio/parameters.c:331: flash_write_scratch(PARAM_E_FLASH_START, sizeof(encryption_key));
	mov	r0,#_flash_write_scratch_PARM_2
	mov	a,#0x20
	movx	@r0,a
	mov	dptr,#0x0180
	lcall	_flash_write_scratch
;	radio/parameters.c:332: write_params((__xdata uint8_t *)encryption_key, PARAM_E_FLASH_START+1, sizeof(encryption_key));
	mov	dptr,#_write_params_PARM_2
	mov	a,#0x81
	movx	@dptr,a
	mov	a,#0x01
...
;	radio/parameters.c:382: return v;
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'read_hex_nibble'
;------------------------------------------------------------
;c                         Allocated to registers r7 
;------------------------------------------------------------
;	radio/parameters.c:495: uint8_t read_hex_nibble(const uint8_t c) __reentrant
;	-----------------------------------------
;	 function read_hex_nibble
;	-----------------------------------------
_read_hex_nibble:
	mov	r7,dpl
;	radio/parameters.c:497: if ((c >='0') && (c <= '9'))
	cjne	r7,#0x30,00133$
00133$:
	jc	00110$
	mov	a,r7
	add	a,#0xff - 0x39
	jc	00110$
;	radio/parameters.c:499: return c - '0';
	mov	ar6,r7
	mov	a,r6
	add	a,#0xD0
	mov	dpl,a
	ret
00110$:
;	radio/parameters.c:501: else if ((c >='A') && (c <= 'F'))
	cjne	r7,#0x41,00136$
00136$:
	jc	00106$
	mov	a,r7
	add	a,#0xff - 0x46
	jc	00106$
;	radio/parameters.c:503: return c - 'A' + 10;
	mov	ar6,r7
	mov	a,#0xC9
	add	a,r6
	mov	dpl,a
	ret
00106$:
;	radio/parameters.c:505: else if ((c >='a') && (c <= 'f'))
	cjne	r7,#0x61,00139$
00139$:
	jc	00102$
	mov	a,r7
	add	a,#0xff - 0x66
	jc	00102$
;	radio/parameters.c:507: return c - 'a' + 10;
	mov	a,#0xA9
	add	a,r7
	mov	dpl,a
	ret
00102$:
;	radio/parameters.c:512: return 0;
	mov	dpl,#0x00
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'convert_to_hex'
;------------------------------------------------------------
;sloc0                     Allocated with name '_convert_to_hex_sloc0_1_0'
;str_out                   Allocated with name '_convert_to_hex_PARM_2'
;str_in                    Allocated with name '_convert_to_hex_str_in_1_174'
;------------------------------------------------------------
;	radio/parameters.c:519: void convert_to_hex(__xdata unsigned char *str_in, __xdata unsigned char *str_out,	__pdata uint8_t key_length)
;	-----------------------------------------
...
_convert_to_hex:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_convert_to_hex_str_in_1_174
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	radio/parameters.c:523: for (i=0;i<key_length;i++) {
	mov	dptr,#_convert_to_hex_str_in_1_174
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_convert_to_hex_PARM_2
	movx	a,@dptr
	mov	_convert_to_hex_sloc0_1_0,a
	inc	dptr
	movx	a,@dptr
	mov	(_convert_to_hex_sloc0_1_0 + 1),a
	mov	r0,#_convert_to_hex_i_1_175
	clr	a
	movx	@r0,a
00103$:
	mov	r0,#_convert_to_hex_i_1_175
	mov	r1,#_convert_to_hex_PARM_3
	clr	c
	movx	a,@r1
	mov	b,a
	movx	a,@r0
	subb	a,b
	jnc	00105$
;	radio/parameters.c:524: num = read_hex_nibble(str_in[2 * i])<<4;
	mov	r0,#_convert_to_hex_i_1_175
	movx	a,@r0
	mov	b,#0x02
	mul	ab
	...
	anl	a,#0xF0
	mov	r5,a
;	radio/parameters.c:525: num += read_hex_nibble(str_in[2 * i + 1]);
	inc	r2
	cjne	r2,#0x00,00115$
	inc	r3
00115$:
	...
	add	a,r5
	mov	r5,a
;	radio/parameters.c:526: str_out[i] = num;
	mov	r0,#_convert_to_hex_i_1_175
	movx	a,@r0
	add	a,_convert_to_hex_sloc0_1_0
	mov	dpl,a
	clr	a
	addc	a,(_convert_to_hex_sloc0_1_0 + 1)
	mov	dph,a
	mov	a,r5
	movx	@dptr,a
;	radio/parameters.c:523: for (i=0;i<key_length;i++) {
...
00105$:
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'param_set_default_encryption_key'
;------------------------------------------------------------
;b                         Allocated with name '_param_set_default_encryption_key_b_1_178'
;------------------------------------------------------------
;	radio/parameters.c:532: void param_set_default_encryption_key(__pdata uint8_t key_length)
;	-----------------------------------------
;	 function param_set_default_encryption_key
;	-----------------------------------------
_param_set_default_encryption_key:
	mov	r7,dpl
;	radio/parameters.c:535: __xdata uint8_t b[] = {0x62};
	mov	dptr,#_param_set_default_encryption_key_b_1_178
	mov	a,#0x62
	movx	@dptr,a
;	radio/parameters.c:537: for (i=0;i< key_length;i++) {
	mov	r6,#0x00
00103$:
	clr	c
	mov	a,r6
	subb	a,r7
	jnc	00105$
;	radio/parameters.c:539: memcpy(&encryption_key[i], &b, 1);
	mov	a,r6
	add	a,#_encryption_key
	mov	r4,a
	clr	a
	addc	a,#(_encryption_key >> 8)
	mov	r5,a
	mov	r3,#0x00
	mov	dptr,#_memcpy_PARM_2
	mov	a,#_param_set_default_encryption_key_b_1_178
	movx	@dptr,a
	mov	a,#(_param_set_default_encryption_key_b_1_178 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
00105$:
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'param_set_encryption_key'
;------------------------------------------------------------
;sloc0                     Allocated with name '_param_set_encryption_key_sloc0_1_0'
;key                       Allocated with name '_param_set_encryption_key_key_1_180'
;------------------------------------------------------------
;	radio/parameters.c:550: param_set_encryption_key(__xdata unsigned char *key)
;	-----------------------------------------
;	 function param_set_encryption_key
;	-----------------------------------------
_param_set_encryption_key:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_param_set_encryption_key_key_1_180
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	radio/parameters.c:556: key_length = AES_KEY_LENGTH(param_get(PARAM_ENCRYPTION));
	mov	dpl,#0x10
	lcall	_param_get
	mov	r4,dpl
	anl	ar4,#0x0F
	...
	anl	a,#0xF8
	mov	r7,a
;	radio/parameters.c:557: len = strlen(key);
	mov	dptr,#_param_set_encryption_key_key_1_180
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	pop	ar6
	pop	ar7
;	radio/parameters.c:559: if (len < 2 * key_length ) {
	mov	a,r7
	mov	b,#0x02
	mul	ab
	mov	r2,a
	mov	r4,b
	mov	_param_set_encryption_key_sloc0_1_0,r3
	mov	(_param_set_encryption_key_sloc0_1_0 + 1),#0x00
	clr	c
	mov	a,_param_set_encryption_key_sloc0_1_0
	subb	a,r2
	mov	a,(_param_set_encryption_key_sloc0_1_0 + 1)
	xrl	a,#0x80
	mov	b,r4
	xrl	b,#0x80
	subb	a,b
	jnc	00102$
;	radio/parameters.c:560: param_set_default_encryption_key(key_length);
	mov	dpl,r7
	push	ar4
	push	ar2
	lcall	_param_set_default_encryption_key
	pop	ar2
	pop	ar4
;	radio/parameters.c:562: printf("ERROR - Key length:%u, Required %u\n",len, 2 * key_length);
	push	ar2
	push	ar4
	push	_param_set_encryption_key_sloc0_1_0
	push	(_param_set_encryption_key_sloc0_1_0 + 1)
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	add	a,#0xf9
	mov	sp,a
;	radio/parameters.c:563: return true;
	setb	c
	ret
00102$:
;	radio/parameters.c:567: printf("key len %d\n",key_length);
	mov	ar3,r7
	mov	r4,#0x00
	push	ar7
	push	ar6
	...
	pop	ar6
	pop	ar7
;	radio/parameters.c:568: convert_to_hex(key, encryption_key, key_length);
	mov	dptr,#_convert_to_hex_PARM_2
	mov	a,#_encryption_key
	movx	@dptr,a
	mov	a,#(_encryption_key >> 8)
	inc	dptr
	movx	@dptr,a
	mov	r0,#_convert_to_hex_PARM_3
	mov	a,r7
	movx	@r0,a
	mov	dpl,r5
	mov	dph,r6
	lcall	_convert_to_hex
;	radio/parameters.c:571: return true;
	setb	c
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'print_encryption_key'
;------------------------------------------------------------
;	radio/parameters.c:577: print_encryption_key()
;	-----------------------------------------
;	 function print_encryption_key
;	-----------------------------------------
_print_encryption_key:
;	radio/parameters.c:580: __pdata uint8_t key_length = AES_KEY_LENGTH(param_get(PARAM_ENCRYPTION));
	mov	dpl,#0x10
	lcall	_param_get
	mov	r4,dpl
	anl	ar4,#0x0F
	...
	anl	a,#0xF8
	mov	r7,a
;	radio/parameters.c:582: for (i=0; i<key_length; i++) {
	mov	r6,#0x00
00105$:
	clr	c
	mov	a,r6
	subb	a,r7
	jnc	00103$
;	radio/parameters.c:583: if (0xF >= encryption_key[i]) {
	mov	a,r6
	add	a,#_encryption_key
	mov	dpl,a
	clr	a
	...
	add	a,#0xff - 0x0F
	jc	00102$
;	radio/parameters.c:584: printf("0");
	push	ar7
	push	ar6
	mov	a,#___str_2
	push	acc
	...
	pop	ar7
00102$:
;	radio/parameters.c:586: printf("%x",encryption_key[i]);
	mov	a,r6
	add	a,#_encryption_key
	mov	dpl,a
	clr	a
...
;	radio/parameters.c:588: printf("\n");
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'param_get_encryption_key'
;------------------------------------------------------------
;	radio/parameters.c:593: __xdata uint8_t* param_get_encryption_key()
;	-----------------------------------------
;	 function param_get_encryption_key
;	-----------------------------------------
_param_get_encryption_key:
;	radio/parameters.c:595: return encryption_key;
	mov	dptr,#_encryption_key
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
_parameter_info:
	...
	.byte #0x00,#0x00,#0x00,#0x00	; 0
___str_0:
	.ascii "ERROR - Key length:%u, Required %u"
	.db 0x0A
	.db 0x00
___str_1:
	.ascii "key len %d"
