      ...
      0000B4                        800 _flash_write_scratch_PARM_2:
      0000B4                        801 	.ds 1
                                    802 ;--------------------------------------------------------
      ...
      003AE5 75 B7 A5         [24]  857 	mov	_FLKEY,#0xA5
                                    858 ;	radio/flash.c:56: FLKEY = 0xf1;
      003AE8 75 B7 F1         [24]  859 	mov	_FLKEY,#0xF1
      003AEB 22               [24]  860 	ret
                                    861 ;------------------------------------------------------------
                                    ...
                                    867 ;	-----------------------------------------
      003AEC                        868 _flash_erase_scratch:
      003AEC D3               [12]  869 	setb	c
      003AED 10 AF 01         [24]  870 	jbc	ea,00103$
      003AF0 C3               [12]  871 	clr	c
      003AF1                        872 00103$:
      003AF1 C0 D0            [24]  873 	push	psw
                                    874 ;	radio/flash.c:64: __pdata uint8_t	bank_state = PSBANK;
      003AF3 AF 84            [24]  875 	mov	r7,_PSBANK
                                    876 ;	radio/flash.c:65: PSBANK = ((bank_state & 0x03) | 0x30); // Select Bank 3
      003AF5 74 03            [12]  877 	mov	a,#0x03
      003AF7 5F               [12]  878 	anl	a,r7
      003AF8 44 30            [12]  879 	orl	a,#0x30
      003AFA F5 84            [12]  880 	mov	_PSBANK,a
                                    881 ;	radio/flash.c:68: flash_load_keys();				// unlock flash for one operation
      003AFC C0 07            [24]  882 	push	ar7
      003AFE 12 3A E5         [24]  883 	lcall	_flash_load_keys
      003B01 D0 07            [24]  884 	pop	ar7
                                    885 ;	radio/flash.c:69: PSCTL = FLASH_ERASE_SCRATCH;	// enable flash erase of the scratch page
      003B03 75 8F 03         [24]  886 	mov	_PSCTL,#0x03
                                    887 ;	radio/flash.c:70: *(uint8_t __xdata *)FLASH_SCRATCH = 0xff;	// trigger the erase
      003B06 90 00 00         [24]  888 	mov	dptr,#0x0000
      003B09 74 FF            [12]  889 	mov	a,#0xFF
      003B0B F0               [24]  890 	movx	@dptr,a
                                    891 ;	radio/flash.c:71: PSCTL = FLASH_DISABLE;			// disable flash write & scratch access
      003B0C 75 8F 00         [24]  892 	mov	_PSCTL,#0x00
                                    893 ;	radio/flash.c:74: PSBANK = bank_state;
      003B0F 8F 84            [24]  894 	mov	_PSBANK,r7
      003B11 D0 D0            [24]  895 	pop	psw
      003B13 92 AF            [24]  896 	mov	ea,c
      003B15 22               [24]  897 	ret
                                    898 ;------------------------------------------------------------
                                    899 ;Allocation info for local variables in function 'flash_read_scratch'
                                    900 ;------------------------------------------------------------
                                    901 ;d                         Allocated with name '_flash_read_scratch_d_1_131'
                                    902 ;------------------------------------------------------------
                                    903 ;	radio/flash.c:79: flash_read_scratch(__pdata uint16_t address)
                                    904 ;	-----------------------------------------
                                    905 ;	 function flash_read_scratch
                                    906 ;	-----------------------------------------
      003B16                        907 _flash_read_scratch:
      003B16 D3               [12]  908 	setb	c
      003B17 10 AF 01         [24]  909 	jbc	ea,00103$
      003B1A C3               [12]  910 	clr	c
      003B1B                        911 00103$:
      003B1B C0 D0            [24]  912 	push	psw
      003B1D AE 82            [24]  913 	mov	r6,dpl
      003B1F AF 83            [24]  914 	mov	r7,dph
                                    915 ;	radio/flash.c:84: __pdata uint8_t	bank_state = PSBANK;
      003B21 AD 84            [24]  916 	mov	r5,_PSBANK
                                    917 ;	radio/flash.c:85: PSBANK = ((bank_state & 0x03) | 0x30); // Select Bank 3
      003B23 74 03            [12]  918 	mov	a,#0x03
      003B25 5D               [12]  919 	anl	a,r5
      003B26 44 30            [12]  920 	orl	a,#0x30
      003B28 F5 84            [12]  921 	mov	_PSBANK,a
                                    922 ;	radio/flash.c:88: PSCTL = FLASH_READ_SCRATCH;
      003B2A 75 8F 00         [24]  923 	mov	_PSCTL,#0x00
                                    924 ;	radio/flash.c:89: d = *(uint8_t __code *)(FLASH_SCRATCH | address);
      003B2D 8E 82            [24]  925 	mov	dpl,r6
      003B2F 8F 83            [24]  926 	mov	dph,r7
      003B31 E4               [12]  927 	clr	a
      003B32 93               [24]  928 	movc	a,@a+dptr
      003B33 FF               [12]  929 	mov	r7,a
                                    930 ;	radio/flash.c:90: PSCTL = FLASH_DISABLE;
      003B34 75 8F 00         [24]  931 	mov	_PSCTL,#0x00
                                    932 ;	radio/flash.c:93: PSBANK = bank_state;
      003B37 8D 84            [24]  933 	mov	_PSBANK,r5
                                    934 ;	radio/flash.c:95: return d;
      003B39 8F 82            [24]  935 	mov	dpl,r7
      003B3B D0 D0            [24]  936 	pop	psw
      003B3D 92 AF            [24]  937 	mov	ea,c
      003B3F 22               [24]  938 	ret
                                    939 ;------------------------------------------------------------
                                    940 ;Allocation info for local variables in function 'flash_write_scratch'
                                    941 ;------------------------------------------------------------
                                    942 ;	radio/flash.c:99: flash_write_scratch(__pdata uint16_t address, __pdata uint8_t c)
                                    943 ;	-----------------------------------------
                                    944 ;	 function flash_write_scratch
                                    945 ;	-----------------------------------------
      003B40                        946 _flash_write_scratch:
      003B40 D3               [12]  947 	setb	c
      003B41 10 AF 01         [24]  948 	jbc	ea,00103$
      003B44 C3               [12]  949 	clr	c
      003B45                        950 00103$:
      003B45 C0 D0            [24]  951 	push	psw
      003B47 AE 82            [24]  952 	mov	r6,dpl
      003B49 AF 83            [24]  953 	mov	r7,dph
                                    954 ;	radio/flash.c:102: __pdata uint8_t	bank_state = PSBANK;
      003B4B AD 84            [24]  955 	mov	r5,_PSBANK
                                    956 ;	radio/flash.c:103: PSBANK = ((bank_state & 0x03) | 0x30); // Select Bank 3
      003B4D 74 03            [12]  957 	mov	a,#0x03
      003B4F 5D               [12]  958 	anl	a,r5
      003B50 44 30            [12]  959 	orl	a,#0x30
      003B52 F5 84            [12]  960 	mov	_PSBANK,a
                                    961 ;	radio/flash.c:106: flash_load_keys();
      003B54 C0 07            [24]  962 	push	ar7
      003B56 C0 06            [24]  963 	push	ar6
      003B58 C0 05            [24]  964 	push	ar5
      003B5A 12 3A E5         [24]  965 	lcall	_flash_load_keys
      003B5D D0 05            [24]  966 	pop	ar5
      003B5F D0 06            [24]  967 	pop	ar6
      003B61 D0 07            [24]  968 	pop	ar7
                                    969 ;	radio/flash.c:107: PSCTL = 0x05;
      003B63 75 8F 05         [24]  970 	mov	_PSCTL,#0x05
                                    971 ;	radio/flash.c:108: *(uint8_t __xdata *)(FLASH_SCRATCH | address) = c;
      003B66 8E 82            [24]  972 	mov	dpl,r6
      003B68 8F 83            [24]  973 	mov	dph,r7
      003B6A 78 B4            [12]  974 	mov	r0,#_flash_write_scratch_PARM_2
      003B6C E2               [24]  975 	movx	a,@r0
      003B6D F0               [24]  976 	movx	@dptr,a
                                    977 ;	radio/flash.c:111: PSBANK = bank_state;
      003B6E 8D 84            [24]  978 	mov	_PSBANK,r5
                                    979 ;	radio/flash.c:113: PSCTL = FLASH_DISABLE;
      003B70 75 8F 00         [24]  980 	mov	_PSCTL,#0x00
      003B73 D0 D0            [24]  981 	pop	psw
      003B75 92 AF            [24]  982 	mov	ea,c
      003B77 22               [24]  983 	ret
                                    984 	.area CSEG    (CODE)
                                    985 	.area CONST   (CODE)
                                    986 	.area XINIT   (CODE)
                                    987 	.area CABS    (ABS,CODE)
      00F7FE                        988 	.org 0xF7FE
      00F7FE                        989 _app_signature:
      00F7FE 3D                     990 	.db #0x3D	; 61
      00F7FF C2                     991 	.db #0xC2	; 194
