                                    ...
                                    382 	.globl _SP
                                    383 	.globl _P0
                                    384 	.globl _GenerateDecryptionKey_PARM_3
                                    385 	.globl _GenerateDecryptionKey_PARM_2
                                    386 	.globl _GenerateDecryptionKey
                                    387 ;--------------------------------------------------------
      ...
      000000                        676 	.org 0x0000
                           ...
                           000081   767 _IRQ	=	0x0081
                           0000A3   768 _NSS1	=	0x00a3
                                    769 ;--------------------------------------------------------
                                    770 ; overlayable register banks
                                    771 ;--------------------------------------------------------
                                    772 	.area REG_BANK_0	(REL,OVR,DATA)
      000000                        773 	.ds 8
                                    774 ;--------------------------------------------------------
                                    775 ; internal ram data
                                    776 ;--------------------------------------------------------
                                    777 	.area DSEG    (DATA)
                                    778 ;--------------------------------------------------------
                                    779 ; overlayable items in internal ram 
                                    780 ;--------------------------------------------------------
                                    781 ;--------------------------------------------------------
                                    ...
                                    800 ;--------------------------------------------------------
                                    801 	.area XSEG    (XDATA)
      00064B                        802 _GenerateDecryptionKey_PARM_2:
      00064B                        803 	.ds 2
      00064D                        804 _GenerateDecryptionKey_PARM_3:
      00064D                        805 	.ds 1
      00064E                        806 _GenerateDecryptionKey_encryptionKey_1_127:
      00064E                        807 	.ds 2
      000650                        808 _GenerateDecryptionKey_addr_1_128:
      000650                        809 	.ds 2
                                    810 ;--------------------------------------------------------
                                    ...
                                    827 	.area CSEG    (CODE)
                                    828 ;--------------------------------------------------------
                                    829 ; global & static initialisations
                                    830 ;--------------------------------------------------------
                                    831 	.area HOME    (CODE)
                                    ...
                                    843 	.area CSEG    (CODE)
                                    844 ;------------------------------------------------------------
                                    845 ;Allocation info for local variables in function 'GenerateDecryptionKey'
                                    846 ;------------------------------------------------------------
                                    847 ;decryptionKey             Allocated with name '_GenerateDecryptionKey_PARM_2'
                                    848 ;keySize                   Allocated with name '_GenerateDecryptionKey_PARM_3'
                                    849 ;encryptionKey             Allocated with name '_GenerateDecryptionKey_encryptionKey_1_127'
                                    850 ;addr                      Allocated with name '_GenerateDecryptionKey_addr_1_128'
                                    851 ;keyLength                 Allocated with name '_GenerateDecryptionKey_keyLength_1_128'
                                    852 ;------------------------------------------------------------
                                    853 ;	radio/AES/GenerateDecryptionKey.c:84: GenerateDecryptionKey (
                                    854 ;	-----------------------------------------
                                    855 ;	 function GenerateDecryptionKey
                                    856 ;	-----------------------------------------
      005BF0                        857 _GenerateDecryptionKey:
                           000007   858 	ar7 = 0x07
                           000006   859 	ar6 = 0x06
                           000005   860 	ar5 = 0x05
                           000004   861 	ar4 = 0x04
                           ...
                           000001   864 	ar1 = 0x01
                           000000   865 	ar0 = 0x00
      005BF0 AF 83            [24]  866 	mov	r7,dph
      005BF2 E5 82            [12]  867 	mov	a,dpl
      005BF4 90 06 4E         [24]  868 	mov	dptr,#_GenerateDecryptionKey_encryptionKey_1_127
      005BF7 F0               [24]  869 	movx	@dptr,a
      005BF8 EF               [12]  870 	mov	a,r7
      005BF9 A3               [24]  871 	inc	dptr
      005BFA F0               [24]  872 	movx	@dptr,a
                                    873 ;	radio/AES/GenerateDecryptionKey.c:95: if(keySize >= KEY_SIZE_UNDEFINED)
      005BFB 90 06 4D         [24]  874 	mov	dptr,#_GenerateDecryptionKey_PARM_3
      005BFE E0               [24]  875 	movx	a,@dptr
      005BFF FF               [12]  876 	mov	r7,a
      005C00 BF 03 00         [24]  877 	cjne	r7,#0x03,00133$
      005C03                        878 00133$:
      005C03 40 04            [24]  879 	jc	00102$
                                    880 ;	radio/AES/GenerateDecryptionKey.c:97: return ERROR_INVALID_PARAMETER;
      005C05 75 82 01         [24]  881 	mov	dpl,#0x01
      005C08 22               [24]  882 	ret
      005C09                        883 00102$:
                                    884 ;	radio/AES/GenerateDecryptionKey.c:102: keyLength = ((keySize + 2) << 3);
      005C09 74 02            [12]  885 	mov	a,#0x02
      005C0B 2F               [12]  886 	add	a,r7
      005C0C C4               [12]  887 	swap	a
      005C0D 03               [12]  888 	rr	a
      005C0E 54 F8            [12]  889 	anl	a,#0xF8
      005C10 FE               [12]  890 	mov	r6,a
                                    891 ;	radio/AES/GenerateDecryptionKey.c:105: SFRPAGE = DPPE_PAGE;
      005C11 75 A7 02         [24]  892 	mov	_SFRPAGE,#0x02
                                    893 ;	radio/AES/GenerateDecryptionKey.c:107: AES0BCFG = 0x00;                      // disable, for now
      005C14 75 E9 00         [24]  894 	mov	_AES0BCFG,#0x00
                                    895 ;	radio/AES/GenerateDecryptionKey.c:108: AES0DCFG = 0x00;                      // disable for now
      005C17 75 EA 00         [24]  896 	mov	_AES0DCFG,#0x00
                                    897 ;	radio/AES/GenerateDecryptionKey.c:111: DMA0EN &= ~AES0_KBY_MASK;
      005C1A AD D2            [24]  898 	mov	r5,_DMA0EN
      005C1C 74 A7            [12]  899 	mov	a,#0xA7
      005C1E 5D               [12]  900 	anl	a,r5
      005C1F F5 D2            [12]  901 	mov	_DMA0EN,a
                                    902 ;	radio/AES/GenerateDecryptionKey.c:117: DMA0SEL  = AES0KIN_CHANNEL;
      005C21 75 D1 03         [24]  903 	mov	_DMA0SEL,#0x03
                                    904 ;	radio/AES/GenerateDecryptionKey.c:118: DMA0NCF  = AES0KIN_PERIPHERAL_REQUEST;
      005C24 75 C9 05         [24]  905 	mov	_DMA0NCF,#0x05
                                    906 ;	radio/AES/GenerateDecryptionKey.c:119: DMA0NMD  = NO_WRAPPING;
      005C27 75 D6 00         [24]  907 	mov	_DMA0NMD,#0x00
                                    908 ;	radio/AES/GenerateDecryptionKey.c:120: addr.U16 = (U16)(encryptionKey);
      005C2A 90 06 4E         [24]  909 	mov	dptr,#_GenerateDecryptionKey_encryptionKey_1_127
      005C2D E0               [24]  910 	movx	a,@dptr
      005C2E FC               [12]  911 	mov	r4,a
      005C2F A3               [24]  912 	inc	dptr
      005C30 E0               [24]  913 	movx	a,@dptr
      005C31 FD               [12]  914 	mov	r5,a
      005C32 90 06 50         [24]  915 	mov	dptr,#_GenerateDecryptionKey_addr_1_128
      005C35 EC               [12]  916 	mov	a,r4
      005C36 F0               [24]  917 	movx	@dptr,a
      005C37 ED               [12]  918 	mov	a,r5
      005C38 A3               [24]  919 	inc	dptr
      005C39 F0               [24]  920 	movx	@dptr,a
                                    921 ;	radio/AES/GenerateDecryptionKey.c:121: DMA0NBAL = addr.U8[LSB];
      005C3A 90 06 50         [24]  922 	mov	dptr,#_GenerateDecryptionKey_addr_1_128
      005C3D E0               [24]  923 	movx	a,@dptr
      005C3E F5 CA            [12]  924 	mov	_DMA0NBAL,a
                                    925 ;	radio/AES/GenerateDecryptionKey.c:122: DMA0NBAH = addr.U8[MSB];
      005C40 90 06 51         [24]  926 	mov	dptr,#(_GenerateDecryptionKey_addr_1_128 + 0x0001)
      005C43 E0               [24]  927 	movx	a,@dptr
      005C44 F5 CB            [12]  928 	mov	_DMA0NBAH,a
                                    929 ;	radio/AES/GenerateDecryptionKey.c:123: DMA0NSZH = 0;
      005C46 75 CF 00         [24]  930 	mov	_DMA0NSZH,#0x00
                                    931 ;	radio/AES/GenerateDecryptionKey.c:124: DMA0NSZL = keyLength;
      005C49 8E CE            [24]  932 	mov	_DMA0NSZL,r6
                                    933 ;	radio/AES/GenerateDecryptionKey.c:125: DMA0NAOL = 0;
      005C4B 75 CC 00         [24]  934 	mov	_DMA0NAOL,#0x00
                                    935 ;	radio/AES/GenerateDecryptionKey.c:126: DMA0NAOH = 0;
      005C4E 75 CD 00         [24]  936 	mov	_DMA0NAOH,#0x00
                                    937 ;	radio/AES/GenerateDecryptionKey.c:133: DMA0SEL  = AES0BIN_CHANNEL;
      005C51 75 D1 04         [24]  938 	mov	_DMA0SEL,#0x04
                                    939 ;	radio/AES/GenerateDecryptionKey.c:134: DMA0NCF  = AES0BIN_PERIPHERAL_REQUEST;
      005C54 75 C9 06         [24]  940 	mov	_DMA0NCF,#0x06
                                    941 ;	radio/AES/GenerateDecryptionKey.c:135: DMA0NMD  = NO_WRAPPING;
      005C57 75 D6 00         [24]  942 	mov	_DMA0NMD,#0x00
                                    943 ;	radio/AES/GenerateDecryptionKey.c:136: DMA0NBAL = 0x00;
      005C5A 75 CA 00         [24]  944 	mov	_DMA0NBAL,#0x00
                                    945 ;	radio/AES/GenerateDecryptionKey.c:137: DMA0NBAH = 0x00;
      005C5D 75 CB 00         [24]  946 	mov	_DMA0NBAH,#0x00
                                    947 ;	radio/AES/GenerateDecryptionKey.c:138: DMA0NSZH = 0;
      005C60 75 CF 00         [24]  948 	mov	_DMA0NSZH,#0x00
                                    949 ;	radio/AES/GenerateDecryptionKey.c:139: DMA0NSZL = 16;                       // one block
      005C63 75 CE 10         [24]  950 	mov	_DMA0NSZL,#0x10
                                    951 ;	radio/AES/GenerateDecryptionKey.c:140: DMA0NAOL = 0;
      005C66 75 CC 00         [24]  952 	mov	_DMA0NAOL,#0x00
                                    953 ;	radio/AES/GenerateDecryptionKey.c:141: DMA0NAOH = 0;
      005C69 75 CD 00         [24]  954 	mov	_DMA0NAOH,#0x00
                                    955 ;	radio/AES/GenerateDecryptionKey.c:147: DMA0SEL = AES0YOUT_CHANNEL;
      005C6C 75 D1 06         [24]  956 	mov	_DMA0SEL,#0x06
                                    957 ;	radio/AES/GenerateDecryptionKey.c:148: DMA0NCF = AES0YOUT_PERIPHERAL_REQUEST|DMA_INT_EN;
      005C6F 75 C9 88         [24]  958 	mov	_DMA0NCF,#0x88
                                    959 ;	radio/AES/GenerateDecryptionKey.c:149: DMA0NMD = NO_WRAPPING;
      005C72 75 D6 00         [24]  960 	mov	_DMA0NMD,#0x00
                                    961 ;	radio/AES/GenerateDecryptionKey.c:150: addr.U16 = (U16)(decryptionKey);
      005C75 90 06 4B         [24]  962 	mov	dptr,#_GenerateDecryptionKey_PARM_2
      005C78 E0               [24]  963 	movx	a,@dptr
      005C79 FC               [12]  964 	mov	r4,a
      005C7A A3               [24]  965 	inc	dptr
      005C7B E0               [24]  966 	movx	a,@dptr
      005C7C FD               [12]  967 	mov	r5,a
      005C7D 90 06 50         [24]  968 	mov	dptr,#_GenerateDecryptionKey_addr_1_128
      005C80 EC               [12]  969 	mov	a,r4
      005C81 F0               [24]  970 	movx	@dptr,a
      005C82 ED               [12]  971 	mov	a,r5
      005C83 A3               [24]  972 	inc	dptr
      005C84 F0               [24]  973 	movx	@dptr,a
                                    974 ;	radio/AES/GenerateDecryptionKey.c:151: DMA0NBAL = addr.U8[LSB];
      005C85 90 06 50         [24]  975 	mov	dptr,#_GenerateDecryptionKey_addr_1_128
      005C88 E0               [24]  976 	movx	a,@dptr
      005C89 F5 CA            [12]  977 	mov	_DMA0NBAL,a
                                    978 ;	radio/AES/GenerateDecryptionKey.c:152: DMA0NBAH = addr.U8[MSB];
      005C8B 90 06 51         [24]  979 	mov	dptr,#(_GenerateDecryptionKey_addr_1_128 + 0x0001)
      005C8E E0               [24]  980 	movx	a,@dptr
      005C8F F5 CB            [12]  981 	mov	_DMA0NBAH,a
                                    982 ;	radio/AES/GenerateDecryptionKey.c:153: DMA0NSZH = 0;
      005C91 75 CF 00         [24]  983 	mov	_DMA0NSZH,#0x00
                                    984 ;	radio/AES/GenerateDecryptionKey.c:154: DMA0NSZL = keyLength;
      005C94 8E CE            [24]  985 	mov	_DMA0NSZL,r6
                                    986 ;	radio/AES/GenerateDecryptionKey.c:155: DMA0NAOH = 0;
      005C96 75 CD 00         [24]  987 	mov	_DMA0NAOH,#0x00
                                    988 ;	radio/AES/GenerateDecryptionKey.c:158: if (keySize> KEY_SIZE_128_BITS)     // if extended key
      005C99 EF               [12]  989 	mov	a,r7
      005C9A 60 05            [24]  990 	jz	00105$
                                    991 ;	radio/AES/GenerateDecryptionKey.c:159: DMA0NAOL = 0x10;                 // point to extended portion
      005C9C 75 CC 10         [24]  992 	mov	_DMA0NAOL,#0x10
      005C9F 80 03            [24]  993 	sjmp	00106$
      005CA1                        994 00105$:
                                    995 ;	radio/AES/GenerateDecryptionKey.c:161: DMA0NAOL = 0x00;                 // else point to start
      005CA1 75 CC 00         [24]  996 	mov	_DMA0NAOL,#0x00
      005CA4                        997 00106$:
                                    998 ;	radio/AES/GenerateDecryptionKey.c:164: DMA0INT &= ~AES0_KBY_MASK;
      005CA4 AE D3            [24]  999 	mov	r6,_DMA0INT
      005CA6 74 A7            [12] 1000 	mov	a,#0xA7
      005CA8 5E               [12] 1001 	anl	a,r6
      005CA9 F5 D3            [12] 1002 	mov	_DMA0INT,a
                                   1003 ;	radio/AES/GenerateDecryptionKey.c:168: DMA0EN  |=  AES0_KBY_MASK;
      005CAB 43 D2 58         [24] 1004 	orl	_DMA0EN,#0x58
                                   1005 ;	radio/AES/GenerateDecryptionKey.c:171: AES0DCFG = INVERSE_KEY;
      005CAE 75 EA 04         [24] 1006 	mov	_AES0DCFG,#0x04
                                   1007 ;	radio/AES/GenerateDecryptionKey.c:174: AES0BCFG = keySize;
      005CB1 8F E9            [24] 1008 	mov	_AES0BCFG,r7
                                   1009 ;	radio/AES/GenerateDecryptionKey.c:177: AES0BCFG |= ENCRYPTION_MODE;
      005CB3 43 E9 04         [24] 1010 	orl	_AES0BCFG,#0x04
                                   1011 ;	radio/AES/GenerateDecryptionKey.c:180: AES0BCFG |= AES_ENABLE;
      005CB6 43 E9 08         [24] 1012 	orl	_AES0BCFG,#0x08
                                   1013 ;	radio/AES/GenerateDecryptionKey.c:183: EIE2 |= 0x20;
      005CB9 43 E7 20         [24] 1014 	orl	_EIE2,#0x20
                                   1015 ;	radio/AES/GenerateDecryptionKey.c:188: do
      005CBC                       1016 00107$:
                                   1017 ;	radio/AES/GenerateDecryptionKey.c:193: }  while((DMA0INT & AES0YOUT_MASK)==0);
      005CBC E5 D3            [12] 1018 	mov	a,_DMA0INT
      005CBE 30 E6 FB         [24] 1019 	jnb	acc.6,00107$
                                   1020 ;	radio/AES/GenerateDecryptionKey.c:195: if (keySize> KEY_SIZE_128_BITS)     // if extended key
      005CC1 EF               [12] 1021 	mov	a,r7
      005CC2 60 22            [24] 1022 	jz	00112$
                                   1023 ;	radio/AES/GenerateDecryptionKey.c:202: DMA0EN &= ~AES0_KBY_MASK;
      005CC4 AF D2            [24] 1024 	mov	r7,_DMA0EN
      005CC6 74 A7            [12] 1025 	mov	a,#0xA7
      005CC8 5F               [12] 1026 	anl	a,r7
      005CC9 F5 D2            [12] 1027 	mov	_DMA0EN,a
                                   1028 ;	radio/AES/GenerateDecryptionKey.c:204: DMA0SEL = AES0YOUT_CHANNEL;      // select AES0YOUT DMA ch
      005CCB 75 D1 06         [24] 1029 	mov	_DMA0SEL,#0x06
                                   1030 ;	radio/AES/GenerateDecryptionKey.c:205: DMA0NAOL = 0;                    // reset pointer
      005CCE 75 CC 00         [24] 1031 	mov	_DMA0NAOL,#0x00
                                   1032 ;	radio/AES/GenerateDecryptionKey.c:206: DMA0NSZL = 0x10;                 // set length to 16 (128-bits)
      005CD1 75 CE 10         [24] 1033 	mov	_DMA0NSZL,#0x10
                                   1034 ;	radio/AES/GenerateDecryptionKey.c:209: DMA0INT &= ~AES0_KBXY_MASK;
      005CD4 AF D3            [24] 1035 	mov	r7,_DMA0INT
      005CD6 74 87            [12] 1036 	mov	a,#0x87
      005CD8 5F               [12] 1037 	anl	a,r7
      005CD9 F5 D3            [12] 1038 	mov	_DMA0INT,a
                                   1039 ;	radio/AES/GenerateDecryptionKey.c:213: DMA0EN  |=  AES0YOUT_MASK;
      005CDB 43 D2 40         [24] 1040 	orl	_DMA0EN,#0x40
                                   1041 ;	radio/AES/GenerateDecryptionKey.c:216: EIE2 |= 0x20;
      005CDE 43 E7 20         [24] 1042 	orl	_EIE2,#0x20
                                   1043 ;	radio/AES/GenerateDecryptionKey.c:220: do
      005CE1                       1044 00109$:
                                   1045 ;	radio/AES/GenerateDecryptionKey.c:225: }  while((DMA0INT & AES0YOUT_MASK)==0);
      005CE1 E5 D3            [12] 1046 	mov	a,_DMA0INT
      005CE3 30 E6 FB         [24] 1047 	jnb	acc.6,00109$
      005CE6                       1048 00112$:
                                   1049 ;	radio/AES/GenerateDecryptionKey.c:229: AES0BCFG = 0x00;
      005CE6 75 E9 00         [24] 1050 	mov	_AES0BCFG,#0x00
                                   1051 ;	radio/AES/GenerateDecryptionKey.c:230: AES0DCFG = 0x00;
      005CE9 75 EA 00         [24] 1052 	mov	_AES0DCFG,#0x00
                                   1053 ;	radio/AES/GenerateDecryptionKey.c:233: DMA0EN &= ~AES0_KBY_MASK;
      005CEC AF D2            [24] 1054 	mov	r7,_DMA0EN
      005CEE 74 A7            [12] 1055 	mov	a,#0xA7
      005CF0 5F               [12] 1056 	anl	a,r7
      005CF1 F5 D2            [12] 1057 	mov	_DMA0EN,a
                                   1058 ;	radio/AES/GenerateDecryptionKey.c:235: DMA0INT &= ~AES0_KBY_MASK;
      005CF3 AF D3            [24] 1059 	mov	r7,_DMA0INT
      005CF5 74 A7            [12] 1060 	mov	a,#0xA7
      005CF7 5F               [12] 1061 	anl	a,r7
      005CF8 F5 D3            [12] 1062 	mov	_DMA0INT,a
                                   1063 ;	radio/AES/GenerateDecryptionKey.c:237: return SUCCESS;
      005CFA 75 82 00         [24] 1064 	mov	dpl,#0x00
      005CFD 22               [24] 1065 	ret
                                   1066 	.area CSEG    (CODE)
                                   1067 	.area CONST   (CODE)
                                   1068 	.area XINIT   (CODE)
