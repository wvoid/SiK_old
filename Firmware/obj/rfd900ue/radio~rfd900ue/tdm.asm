...
_tdm_show_rssi_sloc4_1_0:
	.ds 2
_tdm_show_rssi_sloc5_1_0:
	.ds 2
_sync_tx_windows_old_state_1_168:
	.ds 1
...
_remote_at_cmd:
	.ds 70
_sync_tx_windows_delta_2_175:
	.ds 2
_tdm_serial_loop_len_1_219:
	.ds 1
_tdm_serial_loop_tdelta_1_219:
	.ds 2
_tdm_serial_loop_last_t_1_219:
	.ds 2
_tdm_serial_loop_last_link_update_1_219:
	.ds 2
;--------------------------------------------------------
; external ram data
;--------------------------------------------------------
...
_test_display::
	.ds 1
_link_update_unlock_count_1_198:
	.ds 1
_link_update_temperature_count_1_198:
	.ds 1
_tdm_init_i_1_270:
	.ds 2
_tdm_init_window_width_1_270:
	.ds 4
;--------------------------------------------------------
...
;unlock_count              Allocated with name '_link_update_unlock_count_1_198'
;temperature_count         Allocated with name '_link_update_temperature_count_1_198'
;------------------------------------------------------------
;	radio/tdm.c:383: static uint8_t unlock_count = 10, temperature_count;
	mov	dptr,#_link_update_unlock_count_1_198
	mov	a,#0x0A
	movx	@dptr,a
;--------------------------------------------------------
; Home
...
;sloc5                     Allocated with name '_tdm_show_rssi_sloc5_1_0'
;------------------------------------------------------------
...
;	1-genFromRTrack replaced	mov	(_tdm_show_rssi_sloc0_1_0 + 1),#0x00
	mov	(_tdm_show_rssi_sloc0_1_0 + 1),r4
	mov	r0,#_remote_statistics
	movx	a,@r0
	mov	r3,a
	mov	_tdm_show_rssi_sloc1_1_0,r3
;	1-genFromRTrack replaced	mov	(_tdm_show_rssi_sloc1_1_0 + 1),#0x00
	mov	(_tdm_show_rssi_sloc1_1_0 + 1),r4
	mov	r0,#_statistics
	movx	a,@r0
	mov	r3,a
	mov	r2,#0x00
	...
	add	a,#0xf3
	mov	sp,a
;	radio/tdm.c:171: printf(" txe=%u rxe=%u stx=%u srx=%u ecc=%u/%u crce=%u temp=%d dco=%u\n",
	...
	mov	r0,#_errors
	movx	a,@r0
	mov	_tdm_show_rssi_sloc5_1_0,a
	inc	r0
	movx	a,@r0
	mov	(_tdm_show_rssi_sloc5_1_0 + 1),a
	...
	push	_tdm_show_rssi_sloc5_1_0
	push	(_tdm_show_rssi_sloc5_1_0 + 1)
	push	ar2
	push	ar3
	mov	a,#___str_1
	push	acc
...
;------------------------------------------------------------
;old_state                 Allocated with name '_sync_tx_windows_old_state_1_168'
;------------------------------------------------------------
...
;	radio/tdm.c:223: __data enum tdm_state old_state = tdm_state;
	mov	r0,#_tdm_state
	movx	a,@r0
	mov	_sync_tx_windows_old_state_1_168,a
...
;	radio/tdm.c:229: if (old_state == TDM_SILENCE1) {
	mov	a,#0x01
	cjne	a,_sync_tx_windows_old_state_1_168,00106$
...
;	radio/tdm.c:236: } else if (old_state == TDM_RECEIVE || old_state == TDM_SILENCE2) {
	mov	a,#0x02
	cjne	a,_sync_tx_windows_old_state_1_168,00151$
	sjmp	00101$
00151$:
	mov	a,#0x03
	cjne	a,_sync_tx_windows_old_state_1_168,00102$
00101$:
...
;	radio/tdm.c:265: delta = old_remaining - tdm_state_remaining;
	mov	r0,#_tdm_state_remaining
	mov	r1,#_sync_tx_windows_delta_2_175
	setb	c
	movx	a,@r0
	subb	a,r4
	cpl	a
...
;	radio/tdm.c:266: if (old_state != tdm_state ||
	mov	r0,#_tdm_state
	movx	a,@r0
	cjne	a,_sync_tx_windows_old_state_1_168,00113$
;	radio/tdm.c:267: delta > (int16_t)packet_latency/2 ||
	...
	pop	ar2
	pop	ar3
	mov	r0,#_sync_tx_windows_delta_2_175
	clr	c
	movx	a,@r0
	mov	b,a
	mov	a,r6
...
;	radio/tdm.c:269: printf("TDM: %u/%u len=%u ",
	...
	mov	r2,a
	mov	r3,#0x00
	mov	r4,_sync_tx_windows_old_state_1_168
	mov	r5,#0x00
	push	ar7
	push	ar6
	push	ar2
...
;	radio/tdm.c:447: temperature_count++;
	mov	dptr,#_link_update_temperature_count_1_198
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
...
;	radio/tdm.c:516: __pdata uint16_t last_t = timer2_tick();
	lcall	_timer2_tick
	mov	r0,#_tdm_serial_loop_last_t_1_219
	mov	a,dpl
	movx	@r0,a
	inc	r0
	mov	a,dph
...
;	radio/tdm.c:517: __pdata uint16_t last_link_update = last_t;
	mov	r0,#_tdm_serial_loop_last_t_1_219
	mov	r1,#_tdm_serial_loop_last_link_update_1_219
	movx	a,@r0
	movx	@r1,a
	inc	r0
	movx	a,@r0
...
;	radio/tdm.c:552: if (radio_receive_packet(&len, pbuf)) {
	...
	mov	a,#(_pbuf >> 8)
	movx	@r0,a
	mov	dptr,#_tdm_serial_loop_len_1_219
	mov	b,#0x60
	push	ar3
	push	ar2
...
;	radio/tdm.c:566: if (len < 2) {
	mov	r0,#_tdm_serial_loop_len_1_219
	movx	a,@r0
	cjne	a,#0x02,00397$
00397$:
	jnc	00398$
...
;	radio/tdm.c:601: !at_mode_active
	jnb	_at_mode_active,00411$
	ljmp	00215$
00411$:
00120$:
;	radio/tdm.c:607: crc = crc16(len, pbuf);
	mov	_crc16_PARM_2,#_pbuf
	mov	(_crc16_PARM_2 + 1),#(_pbuf >> 8)
	mov	r0,#_tdm_serial_loop_len_1_219
	movx	a,@r0
	mov	dpl,a
	lcall	_crc16
	mov	r6,dpl
	mov	r7,dph
;	radio/tdm.c:610: if (crc == trailer.crc) {
	...
	mov	a,r7
	cjne	a,ar5,00118$
;	radio/tdm.c:611: LED_ACTIVITY = LED_ON;
	setb	_LED_RED
;	radio/tdm.c:612: serial_decrypt_buf(pbuf, len);
	mov	r0,#_tdm_serial_loop_len_1_219
	mov	r1,#_serial_decrypt_buf_PARM_2
	movx	a,@r0
	movx	@r1,a
	mov	dptr,#_pbuf
	lcall	_serial_decrypt_buf
;	radio/tdm.c:613: LED_ACTIVITY = LED_OFF;
	clr	_LED_RED
	ljmp	00215$
00118$:
;	radio/tdm.c:615: if (errors.crc_errors != 0xFFFF) {
	mov	r0,#(_errors + 0x000c)
	movx	a,@r0
	mov	r6,a
	inc	r0
	...
	ljmp	00215$
00414$:
;	radio/tdm.c:616: errors.crc_errors++; 
	mov	r0,#(_errors + 0x000c)
	movx	a,@r0
	mov	r6,a
	inc	r0
...
;	radio/tdm.c:634: tdelta = tnow - last_t;
	mov	r0,#_tdm_serial_loop_last_t_1_219
	mov	r1,#_tdm_serial_loop_tdelta_1_219
	setb	c
	movx	a,@r0
	subb	a,r2
	cpl	a
...
;	radio/tdm.c:635: tdm_state_update(tdelta);
	mov	r0,#_tdm_serial_loop_tdelta_1_219
	movx	a,@r0
	mov	dpl,a
	inc	r0
	movx	a,@r0
...
;	radio/tdm.c:639: if (tnow - last_link_update > 32768) {
	mov	r0,#_tdm_serial_loop_last_link_update_1_219
	setb	c
	movx	a,@r0
	subb	a,r2
	cpl	a
...
;	radio/tdm.c:717: max_xmit -= sizeof(trailer)+1;
	...
	add	a,#0xFB
	mov	r6,a
;	radio/tdm.c:720: if (aes_get_encryption_level() > 0) {
	push	ar6
	lcall	_aes_get_encryption_level
	mov	a,dpl
	pop	ar6
	jz	00167$
;	radio/tdm.c:721: if (max_xmit < 16) {
	cjne	r6,#0x10,00435$
00435$:
	jnc	00436$
	ljmp	00215$
00436$:
;	radio/tdm.c:727: max_xmit -= 16;
	mov	a,r6
	add	a,#0xF0
	mov	r6,a
00167$:
...
;	radio/tdm.c:755: trailer.command = 0;
	...
	movx	@r0,a
00172$:
;	radio/tdm.c:758: trailer.crc = crc16(len, pbuf);
	mov	_crc16_PARM_2,#_pbuf
	mov	(_crc16_PARM_2 + 1),#(_pbuf >> 8)
	mov	dpl,r7
	push	ar6
...
;	radio/tdm.c:780: trailer.resend = 0;
	...
	sjmp	00184$
00183$:
;	radio/tdm.c:787: if (aes_get_encryption_level() > 0) {
	lcall	_aes_get_encryption_level
	mov	a,dpl
	jz	00180$
;	radio/tdm.c:789: trailer.window = (uint16_t)(tdm_state_remaining - flight_time_estimate(16 * (1 + (len+sizeof(trailer)>>4))));
	mov	r0,#_tdm_serial_loop_len_1_219
	movx	a,@r0
	mov	r6,a
	mov	r7,#0x00
...
00450$:
	...
	sjmp	00184$
00180$:
;	radio/tdm.c:791: trailer.window = (uint16_t)(tdm_state_remaining - flight_time_estimate(len+sizeof(trailer)));		
	mov	r0,#_tdm_serial_loop_len_1_219
	movx	a,@r0
	add	a,#0x04
	mov	dpl,a
...
;	radio/tdm.c:839: LED_ACTIVITY = LED_OFF;
	clr	_LED_RED
00203$:
;	radio/tdm.c:844: if(tdm_state_remaining > tx_window_width/2)
	mov	r0,#_tx_window_width
	movx	a,@r0
	mov	r6,a
	inc	r0
	...
	subb	a,b
	jnc	00212$
;	radio/tdm.c:848: if (encrypt_buffer_getting_full()) {
	lcall	_encrypt_buffer_getting_full
	jnc	00209$
;	radio/tdm.c:849: while (!encrypt_buffer_getting_empty()) {
00205$:
	lcall	_encrypt_buffer_getting_empty
	jc	00212$
;	radio/tdm.c:850: decryptPackets();
	lcall	_decryptPackets
	sjmp	00205$
00209$:
;	radio/tdm.c:853: decryptPackets();
	lcall	_decryptPackets
00212$:
...
;i                         Allocated with name '_tdm_init_i_1_270'
;air_rate                  Allocated with name '_tdm_init_air_rate_1_270'
;window_width              Allocated with name '_tdm_init_window_width_1_270'
;------------------------------------------------------------
...
;	radio/tdm.c:1020: window_width = 3*(packet_latency+(max_data_packet_length*(uint32_t)ticks_per_byte));
	...
	mov	r6,b
	mov	r7,a
	mov	dptr,#_tdm_init_window_width_1_270
	mov	a,r4
	movx	@dptr,a
	mov	a,r5
	inc	dptr
...
___str_0:
	...
	.db 0x00
___str_1:
	.ascii " txe=%u rxe=%u stx=%u srx=%u ecc=%u/%u crce=%u temp=%d dco=%"
	.ascii "u"
	.db 0x0A
	.db 0x00
___str_2:
