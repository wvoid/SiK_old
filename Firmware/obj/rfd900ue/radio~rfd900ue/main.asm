...
; This file was generated Sun Sep 18 12:39:59 2022
;--------------------------------------------------------
	.module main
...
_feature_mavlink_framing::
	.ds 1
_radio_init_freq_min_1_168:
	.ds 4
_radio_init_freq_max_1_168:
	.ds 4
_radio_init_channel_spacing_1_168:
	.ds 4
_radio_init_txpower_1_168:
	.ds 1
;--------------------------------------------------------
...
;	radio/main.c:134: panic("failed to enable receiver");
	...
	dec	sp
00104$:
;	radio/main.c:144: if (! aes_init(param_get(PARAM_ENCRYPTION))) {
	mov	dpl,#0x10
	lcall	_param_get
	mov	r4,dpl
	mov	dpl,r4
	lcall	_aes_init
	jc	00106$
;	radio/main.c:145: panic("failed to initialise aes");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
...
;------------------------------------------------------------
;i                         Allocated with name '_hardware_init_i_1_166'
;------------------------------------------------------------
...
;freq_min                  Allocated with name '_radio_init_freq_min_1_168'
;freq_max                  Allocated with name '_radio_init_freq_max_1_168'
;channel_spacing           Allocated with name '_radio_init_channel_spacing_1_168'
;txpower                   Allocated with name '_radio_init_txpower_1_168'
;------------------------------------------------------------
...
;	radio/main.c:300: freq_min = 433050000UL;
	mov	dptr,#_radio_init_freq_min_1_168
	mov	a,#0x90
	movx	@dptr,a
	mov	a,#0xD1
	inc	dptr
...
;	radio/main.c:301: freq_max = 434790000UL;
	mov	dptr,#_radio_init_freq_max_1_168
	mov	a,#0x70
	movx	@dptr,a
	mov	a,#0x5E
	inc	dptr
...
;	radio/main.c:302: txpower = 10;
	mov	dptr,#_radio_init_txpower_1_168
	mov	a,#0x0A
	movx	@dptr,a
...
;	radio/main.c:393: channel_spacing = (freq_max - freq_min) / (num_fh_channels+2);
	...
	mov	r6,b
	mov	r7,a
	mov	dptr,#_radio_init_channel_spacing_1_168
	mov	a,r4
	movx	@dptr,a
	mov	a,r5
	inc	dptr
...
___str_0:
	...
	.db 0x00
___str_1:
	.ascii "failed to initialise aes"
	.db 0x00
___str_2:
	.db 0x0A
	.ascii "**PANIC**"
