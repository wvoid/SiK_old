...
_preamble_detected:
	.ds 1
_radio_preamble_detected_EX0_saved_1_156:
	.ds 1
_radio_transmit_simple_transmit_started_1_169:
	.ds 1
_radio_transmit_ret_1_185:
	.ds 1
_radio_transmit_EX0_saved_1_185:
	.ds 1
...
_scale_uint32_PARM_2:
	.ds 4
_scale_uint32_value_1_240:
	.ds 4
_set_frequency_registers_frequency_1_248:
	.ds 4
;--------------------------------------------------------
; external ram data
;--------------------------------------------------------
...
_radio_receive_packet_length_1_142:
	.ds 3
_radio_transmit_length_1_184:
	.ds 1
_radio_set_channel_channel_1_198:
	.ds 1
_radio_set_transmit_power_power_1_222:
	.ds 1
_radio_set_transmit_power_i_1_223:
	.ds 1
_radio_set_network_id_id_1_228:
	.ds 2
_set_frequency_registers_band_1_249:
	.ds 1
_radio_set_diversity_state_1_254:
	.ds 1
;--------------------------------------------------------
...
;	radio/radio.c:243: EX0_SAVE_DISABLE;
	mov	c,_EX0
	mov	_radio_preamble_detected_EX0_saved_1_156,c
	clr	_EX0
...
;	radio/radio.c:246: EX0_RESTORE;
	mov	c,_radio_preamble_detected_EX0_saved_1_156
	mov	_EX0,c
...
;	radio/radio.c:339: transmit_started = false;
	clr	_radio_transmit_simple_transmit_started_1_169
...
;	radio/radio.c:354: if (transmit_started && length != 0 && (status & EZRADIOPRO_ITXFFAEM)) {
	jnb	_radio_transmit_simple_transmit_started_1_169,00108$
	mov	a,r7
	jz	00108$
	mov	a,r3
	jnb	acc.5,00108$
...
;	radio/radio.c:370: if (transmit_started && length != 0 && (status & EZRADIOPRO_ITXFFAFULL) == 0) {
	jnb	_radio_transmit_simple_transmit_started_1_169,00114$
	mov	a,r7
	jz	00114$
	mov	a,r3
	jb	acc.6,00114$
...
;	radio/radio.c:402: transmit_started = true;
	setb	_radio_transmit_simple_transmit_started_1_169
;	radio/radio.c:403: continue;
	ljmp	00130$
00122$:
;	radio/radio.c:405: if (transmit_started && (status & 0x02) == 0) {
	jb	_radio_transmit_simple_transmit_started_1_169,00214$
	ljmp	00130$
00214$:
	mov	a,r3
	jnb	acc.1,00215$
...
;------------------------------------------------------------
;length                    Allocated with name '_radio_transmit_length_1_184'
;------------------------------------------------------------
...
_radio_transmit:
	mov	a,dpl
	mov	dptr,#_radio_transmit_length_1_184
	movx	@dptr,a
;	radio/radio.c:507: EX0_SAVE_DISABLE;
	mov	c,_EX0
	mov	_radio_transmit_EX0_saved_1_185,c
	clr	_EX0
;	radio/radio.c:520: ret = radio_transmit_simple(length, buf, timeout_ticks);
	...
	mov	_radio_transmit_ret_1_185,c
;	radio/radio.c:526: EX0_RESTORE;
	mov	c,_radio_transmit_EX0_saved_1_185
	mov	_EX0,c
;	radio/radio.c:527: return ret;
	mov	c,_radio_transmit_ret_1_185
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;status                    Allocated with name '_radio_initialise_status_1_189'
;------------------------------------------------------------
...
;------------------------------------------------------------
;channel                   Allocated with name '_radio_set_channel_channel_1_198'
;------------------------------------------------------------
...
_radio_set_channel:
	mov	a,dpl
	mov	dptr,#_radio_set_channel_channel_1_198
	movx	@dptr,a
...
;------------------------------------------------------------
;power                     Allocated with name '_radio_set_transmit_power_power_1_222'
;i                         Allocated with name '_radio_set_transmit_power_i_1_223'
;------------------------------------------------------------
...
_radio_set_transmit_power:
	mov	a,dpl
	mov	dptr,#_radio_set_transmit_power_power_1_222
	movx	@dptr,a
...
00121$:
	jc	00106$
00113$:
	mov	dptr,#_radio_set_transmit_power_i_1_223
	mov	a,r6
	movx	@dptr,a
...
;------------------------------------------------------------
;id                        Allocated with name '_radio_set_network_id_id_1_228'
;------------------------------------------------------------
...
_radio_set_network_id:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_radio_set_network_id_id_1_228
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
_scale_uint32:
	...
	mov	r5,b
	mov	r4,a
	mov	r0,#_scale_uint32_value_1_240
	mov	a,r7
	movx	@r0,a
	inc	r0
	mov	a,r6
...
;------------------------------------------------------------
;status                    Allocated with name '_software_reset_status_1_243'
;------------------------------------------------------------
...
;------------------------------------------------------------
;band                      Allocated with name '_set_frequency_registers_band_1_249'
;carrier                   Allocated with name '_set_frequency_registers_carrier_1_249'
;------------------------------------------------------------
...
_set_frequency_registers:
	...
	mov	r5,b
	mov	r4,a
	mov	r0,#_set_frequency_registers_frequency_1_248
	mov	a,r7
	movx	@r0,a
	inc	r0
	mov	a,r6
...
;	radio/radio.c:1111: frequency -= 480000000UL;
	mov	r0,#(_set_frequency_registers_frequency_1_248 + 1)
	movx	a,@r0
	add	a,#0xC8
	movx	@r0,a
	inc	r0
...
;	radio/radio.c:1112: band  = frequency / 20000000UL;
	...
	lcall	__divulong
	mov	r2,dpl
	mov	dptr,#_set_frequency_registers_band_1_249
	mov	a,r2
	movx	@dptr,a
...
;------------------------------------------------------------
;state                     Allocated with name '_radio_set_diversity_state_1_254'
;------------------------------------------------------------
...
_radio_set_diversity:
	mov	a,dpl
	mov	dptr,#_radio_set_diversity_state_1_254
	movx	@dptr,a
