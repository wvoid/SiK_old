...
_serial_write_buf_sloc0_1_0:
	.ds 1
_serial_write_space_ES_saved_1_202:
	.ds 1
_serial_read_ES_saved_1_207:
	.ds 1
_serial_peek_ES_saved_1_213:
	.ds 1
_serial_peekx_ES_saved_1_215:
	.ds 1
_serial_read_buf_sloc1_1_0:
	.ds 1
_serial_read_available_ES_saved_1_227:
	.ds 1
;--------------------------------------------------------
...
_encrypt_remove:
	.ds 2
_decryptPackets_len_decrypted_1_173:
	.ds 1
...
_rts_count:
	.ds 1
_decryptPackets_decrypt_buf_1_173:
	.ds 32
_serial_decrypt_buf_buf_1_180:
	.ds 2
_serial_write_buf_buf_1_189:
	.ds 2
_serial_peekx_offset_1_214:
	.ds 2
_serial_read_buf_buf_1_216:
	.ds 2
_serial_device_set_speed_i_1_237:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;decrypt_buf               Allocated with name '_decryptPackets_decrypt_buf_1_173'
;------------------------------------------------------------
...
;	radio/serial.c:285: if (aes_decrypt(&encrypt_buf[encrypt_remove+1], encrypt_buf[encrypt_remove], decrypt_buf, &len_decrypted) != 0) {
	...
	mov	a,#_decryptPackets_decrypt_buf_1_173
	movx	@dptr,a
	mov	a,#(_decryptPackets_decrypt_buf_1_173 >> 8)
	inc	dptr
	movx	@dptr,a
	mov	dptr,#_aes_decrypt_PARM_4
	mov	a,#_decryptPackets_len_decrypted_1_173
	movx	@dptr,a
	mov	a,#(_decryptPackets_len_decrypted_1_173 >> 8)
	inc	dptr
	movx	@dptr,a
	mov	a,#0x60
	inc	dptr
...
;	radio/serial.c:290: serial_write_buf(decrypt_buf, len_decrypted);
	mov	r0,#_decryptPackets_len_decrypted_1_173
	mov	r1,#_serial_write_buf_PARM_2
	movx	a,@r0
	movx	@r1,a
	mov	dptr,#_decryptPackets_decrypt_buf_1_173
...
;buf                       Allocated with name '_serial_decrypt_buf_buf_1_180'
;------------------------------------------------------------
...
_serial_decrypt_buf:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_decrypt_buf_buf_1_180
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;buf                       Allocated with name '_serial_write_buf_buf_1_189'
;------------------------------------------------------------
...
_serial_write_buf:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_write_buf_buf_1_189
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/serial.c:408: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_write_space_ES_saved_1_202,c
	clr	_ES0
...
;	radio/serial.c:410: ES0_RESTORE;
	mov	c,_serial_write_space_ES_saved_1_202
	mov	_ES0,c
...
;	radio/serial.c:433: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_ES_saved_1_207,c
	clr	_ES0
...
;	radio/serial.c:447: ES0_RESTORE;
	mov	c,_serial_read_ES_saved_1_207
	mov	_ES0,c
...
;	radio/serial.c:457: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peek_ES_saved_1_213,c
	clr	_ES0
...
;	radio/serial.c:459: ES0_RESTORE;
	mov	c,_serial_peek_ES_saved_1_213
	mov	_ES0,c
...
;------------------------------------------------------------
;offset                    Allocated with name '_serial_peekx_offset_1_214'
;c                         Allocated to registers r7 
;------------------------------------------------------------
...
_serial_peekx:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_peekx_offset_1_214
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	radio/serial.c:469: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peekx_ES_saved_1_215,c
	clr	_ES0
...
;	radio/serial.c:471: ES0_RESTORE;
	mov	c,_serial_peekx_ES_saved_1_215
	mov	_ES0,c
...
;buf                       Allocated with name '_serial_read_buf_buf_1_216'
;------------------------------------------------------------
...
_serial_read_buf:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_read_buf_buf_1_216
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/serial.c:525: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_available_ES_saved_1_227,c
	clr	_ES0
...
;	radio/serial.c:527: ES0_RESTORE;
	mov	c,_serial_read_available_ES_saved_1_227
	mov	_ES0,c
...
;------------------------------------------------------------
;space                     Allocated with name '_serial_read_space_space_1_229'
;------------------------------------------------------------
...
;------------------------------------------------------------
;i                         Allocated with name '_serial_device_valid_speed_i_1_233'
;num_rates                 Allocated with name '_serial_device_valid_speed_num_rates_1_233'
;speed                     Allocated to registers r7 
;------------------------------------------------------------
...
;------------------------------------------------------------
;speed                     Allocated to registers r7 
;i                         Allocated with name '_serial_device_set_speed_i_1_237'
;num_rates                 Allocated with name '_serial_device_set_speed_num_rates_1_237'
;------------------------------------------------------------
...
;	radio/serial.c:594: for (i = 0; i < num_rates; i++) {
	...
	sjmp	00107$
00115$:
	mov	dptr,#_serial_device_set_speed_i_1_237
	mov	a,r6
	movx	@dptr,a
