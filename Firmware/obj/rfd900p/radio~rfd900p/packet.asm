...
;	radio/packet.c:209: return slen;
	mov	r4,_packet_get_next_slen_1_164
	mov	dpl,r4
	ret
00104$:
...
;	radio/packet.c:234: slen = max_xmit;
	mov	_packet_get_next_slen_1_164,r5
	mov	(_packet_get_next_slen_1_164 + 1),r6
00112$:
...
;	radio/packet.c:257: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_164,00252$
	clr	a
	cjne	a,(_packet_get_next_slen_1_164 + 1),00252$
	sjmp	00253$
00252$:
	sjmp	00123$
00253$:
...
;	radio/packet.c:295: if (c == MAVLINK10_STX || c == MAVLINK20_STX) {
	mov	a,#0xFE
	cjne	a,_packet_get_next_c_2_180,00259$
	sjmp	00150$
00259$:
	mov	a,#0xFD
	cjne	a,_packet_get_next_c_2_180,00260$
	sjmp	00261$
00260$:
	ljmp	00151$
00261$:
...
;	radio/packet.c:296: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_164,00262$
	clr	a
	cjne	a,(_packet_get_next_slen_1_164 + 1),00262$
	sjmp	00263$
00262$:
	sjmp	00135$
00263$:
...
;	radio/packet.c:314: slen--;				
	...
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_164,00268$
...
;	radio/packet.c:321: if (c == MAVLINK20_STX) {
	mov	a,#0xFD
	cjne	a,_packet_get_next_c_2_180,00143$
...
;	radio/packet.c:350: slen--;
	dec	_packet_get_next_slen_1_164
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_164,00275$
	dec	(_packet_get_next_slen_1_164 + 1)
00275$:
	ljmp	00154$
00156$:
