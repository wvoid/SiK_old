...
_serial_write_buf_sloc0_1_0:
	.ds 1
_serial_write_space_ES_saved_1_192:
	.ds 1
_serial_read_ES_saved_1_197:
	.ds 1
_serial_peek_ES_saved_1_203:
	.ds 1
_serial_peekx_ES_saved_1_205:
	.ds 1
_serial_read_buf_sloc1_1_0:
	.ds 1
_serial_read_available_ES_saved_1_217:
	.ds 1
;--------------------------------------------------------
...
_rts_count:
	.ds 1
_serial_write_buf_buf_1_179:
	.ds 2
_serial_peekx_offset_1_204:
	.ds 2
_serial_read_buf_buf_1_206:
	.ds 2
_serial_device_set_speed_i_1_227:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;buf                       Allocated with name '_serial_write_buf_buf_1_179'
;------------------------------------------------------------
...
_serial_write_buf:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_write_buf_buf_1_179
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/serial.c:408: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_write_space_ES_saved_1_192,c
	clr	_ES0
...
;	radio/serial.c:410: ES0_RESTORE;
	mov	c,_serial_write_space_ES_saved_1_192
	mov	_ES0,c
...
;	radio/serial.c:433: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_ES_saved_1_197,c
	clr	_ES0
...
;	radio/serial.c:447: ES0_RESTORE;
	mov	c,_serial_read_ES_saved_1_197
	mov	_ES0,c
...
;	radio/serial.c:457: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peek_ES_saved_1_203,c
	clr	_ES0
...
;	radio/serial.c:459: ES0_RESTORE;
	mov	c,_serial_peek_ES_saved_1_203
	mov	_ES0,c
...
;------------------------------------------------------------
;offset                    Allocated with name '_serial_peekx_offset_1_204'
;c                         Allocated to registers r7 
;------------------------------------------------------------
...
_serial_peekx:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_peekx_offset_1_204
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	radio/serial.c:469: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peekx_ES_saved_1_205,c
	clr	_ES0
...
;	radio/serial.c:471: ES0_RESTORE;
	mov	c,_serial_peekx_ES_saved_1_205
	mov	_ES0,c
...
;buf                       Allocated with name '_serial_read_buf_buf_1_206'
;------------------------------------------------------------
...
_serial_read_buf:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_read_buf_buf_1_206
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/serial.c:525: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_available_ES_saved_1_217,c
	clr	_ES0
...
;	radio/serial.c:527: ES0_RESTORE;
	mov	c,_serial_read_available_ES_saved_1_217
	mov	_ES0,c
...
;------------------------------------------------------------
;space                     Allocated with name '_serial_read_space_space_1_219'
;------------------------------------------------------------
...
;------------------------------------------------------------
;i                         Allocated with name '_serial_device_valid_speed_i_1_223'
;num_rates                 Allocated with name '_serial_device_valid_speed_num_rates_1_223'
;speed                     Allocated to registers r7 
;------------------------------------------------------------
...
;------------------------------------------------------------
;speed                     Allocated to registers r7 
;i                         Allocated with name '_serial_device_set_speed_i_1_227'
;num_rates                 Allocated with name '_serial_device_set_speed_num_rates_1_227'
;------------------------------------------------------------
...
;	radio/serial.c:594: for (i = 0; i < num_rates; i++) {
	...
	sjmp	00107$
00115$:
	mov	dptr,#_serial_device_set_speed_i_1_227
	mov	a,r6
	movx	@dptr,a
