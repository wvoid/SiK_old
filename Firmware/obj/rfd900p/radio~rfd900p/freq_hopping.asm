...
_shuffle_PARM_2:
	.ds 1
_shuffle_array_1_140:
	.ds 2
_fhop_init_array_3_149:
	.ds 2
;--------------------------------------------------------
...
;array                     Allocated with name '_shuffle_array_1_140'
;i                         Allocated with name '_shuffle_i_1_141'
;j                         Allocated with name '_shuffle_j_2_142'
;t                         Allocated with name '_shuffle_t_2_142'
;------------------------------------------------------------
...
;i                         Allocated with name '_fhop_init_i_1_146'
;__00020001                Allocated with name '_fhop_init___00020001_3_149'
;__00020002                Allocated with name '_fhop_init___00020002_3_149'
;array                     Allocated with name '_fhop_init_array_3_149'
;n                         Allocated with name '_fhop_init_n_3_149'
;i                         Allocated with name '_fhop_init_i_4_150'
;j                         Allocated with name '_fhop_init_j_5_151'
;t                         Allocated with name '_fhop_init_t_5_151'
;------------------------------------------------------------
