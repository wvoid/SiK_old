      ...
      00007D                        562 _flash_write_scratch_PARM_2:
      00007D                        563 	.ds 1
                                    564 ;--------------------------------------------------------
      ...
      0038E3 75 B7 A5         [24]  619 	mov	_FLKEY,#0xA5
                                    620 ;	radio/flash.c:56: FLKEY = 0xf1;
      0038E6 75 B7 F1         [24]  621 	mov	_FLKEY,#0xF1
      0038E9 22               [24]  622 	ret
                                    623 ;------------------------------------------------------------
                                    ...
                                    629 ;	-----------------------------------------
      0038EA                        630 _flash_erase_scratch:
      0038EA D3               [12]  631 	setb	c
      0038EB 10 AF 01         [24]  632 	jbc	ea,00103$
      0038EE C3               [12]  633 	clr	c
      0038EF                        634 00103$:
      0038EF C0 D0            [24]  635 	push	psw
                                    636 ;	radio/flash.c:68: flash_load_keys();				// unlock flash for one operation
      0038F1 12 38 E3         [24]  637 	lcall	_flash_load_keys
                                    638 ;	radio/flash.c:69: PSCTL = FLASH_ERASE_SCRATCH;	// enable flash erase of the scratch page
      0038F4 75 8F 07         [24]  639 	mov	_PSCTL,#0x07
                                    640 ;	radio/flash.c:70: *(uint8_t __xdata *)FLASH_SCRATCH = 0xff;	// trigger the erase
      0038F7 90 00 00         [24]  641 	mov	dptr,#0x0000
      0038FA 74 FF            [12]  642 	mov	a,#0xFF
      0038FC F0               [24]  643 	movx	@dptr,a
                                    644 ;	radio/flash.c:71: PSCTL = FLASH_DISABLE;			// disable flash write & scratch access
      0038FD 75 8F 00         [24]  645 	mov	_PSCTL,#0x00
      003900 D0 D0            [24]  646 	pop	psw
      003902 92 AF            [24]  647 	mov	ea,c
      003904 22               [24]  648 	ret
                                    649 ;------------------------------------------------------------
                                    650 ;Allocation info for local variables in function 'flash_read_scratch'
                                    651 ;------------------------------------------------------------
                                    652 ;d                         Allocated with name '_flash_read_scratch_d_1_129'
                                    653 ;------------------------------------------------------------
                                    654 ;	radio/flash.c:79: flash_read_scratch(__pdata uint16_t address)
                                    655 ;	-----------------------------------------
                                    656 ;	 function flash_read_scratch
                                    657 ;	-----------------------------------------
      003905                        658 _flash_read_scratch:
      003905 D3               [12]  659 	setb	c
      003906 10 AF 01         [24]  660 	jbc	ea,00103$
      003909 C3               [12]  661 	clr	c
      00390A                        662 00103$:
      00390A C0 D0            [24]  663 	push	psw
      00390C AE 82            [24]  664 	mov	r6,dpl
      00390E AF 83            [24]  665 	mov	r7,dph
                                    666 ;	radio/flash.c:88: PSCTL = FLASH_READ_SCRATCH;
      003910 75 8F 04         [24]  667 	mov	_PSCTL,#0x04
                                    668 ;	radio/flash.c:89: d = *(uint8_t __code *)(FLASH_SCRATCH | address);
      003913 8E 82            [24]  669 	mov	dpl,r6
      003915 8F 83            [24]  670 	mov	dph,r7
      003917 E4               [12]  671 	clr	a
      003918 93               [24]  672 	movc	a,@a+dptr
      003919 FF               [12]  673 	mov	r7,a
                                    674 ;	radio/flash.c:90: PSCTL = FLASH_DISABLE;
      00391A 75 8F 00         [24]  675 	mov	_PSCTL,#0x00
                                    676 ;	radio/flash.c:95: return d;
      00391D 8F 82            [24]  677 	mov	dpl,r7
      00391F D0 D0            [24]  678 	pop	psw
      003921 92 AF            [24]  679 	mov	ea,c
      003923 22               [24]  680 	ret
                                    681 ;------------------------------------------------------------
                                    ...
                                    687 ;	-----------------------------------------
      003924                        688 _flash_write_scratch:
      003924 D3               [12]  689 	setb	c
      003925 10 AF 01         [24]  690 	jbc	ea,00103$
      003928 C3               [12]  691 	clr	c
      003929                        692 00103$:
      003929 C0 D0            [24]  693 	push	psw
      00392B AE 82            [24]  694 	mov	r6,dpl
      00392D AF 83            [24]  695 	mov	r7,dph
                                    696 ;	radio/flash.c:106: flash_load_keys();
      00392F C0 07            [24]  697 	push	ar7
      003931 C0 06            [24]  698 	push	ar6
      003933 12 38 E3         [24]  699 	lcall	_flash_load_keys
      003936 D0 06            [24]  700 	pop	ar6
      003938 D0 07            [24]  701 	pop	ar7
                                    702 ;	radio/flash.c:107: PSCTL = 0x05;
      00393A 75 8F 05         [24]  703 	mov	_PSCTL,#0x05
                                    704 ;	radio/flash.c:108: *(uint8_t __xdata *)(FLASH_SCRATCH | address) = c;
      00393D 8E 82            [24]  705 	mov	dpl,r6
      00393F 8F 83            [24]  706 	mov	dph,r7
      003941 78 7D            [12]  707 	mov	r0,#_flash_write_scratch_PARM_2
      003943 E2               [24]  708 	movx	a,@r0
      003944 F0               [24]  709 	movx	@dptr,a
                                    710 ;	radio/flash.c:113: PSCTL = FLASH_DISABLE;
      003945 75 8F 00         [24]  711 	mov	_PSCTL,#0x00
      003948 D0 D0            [24]  712 	pop	psw
      00394A 92 AF            [24]  713 	mov	ea,c
      00394C 22               [24]  714 	ret
                                    715 	.area CSEG    (CODE)
                                    716 	.area CONST   (CODE)
                                    717 	.area XINIT   (CODE)
