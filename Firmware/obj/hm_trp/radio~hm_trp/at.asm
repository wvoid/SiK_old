...
;------------------------------------------------------------
;id                        Allocated with name '_print_ID_vals_id_1_166'
...
;param                     Allocated with name '_print_ID_vals_param_1_163'
;------------------------------------------------------------
...
_print_ID_vals:
	mov	a,dpl
	mov	dptr,#_print_ID_vals_param_1_163
	movx	@dptr,a
;	radio/at.c:312: for (id = 0; id < end; id++) {
	...
	movx	a,@dptr
	mov	r6,a
	mov	_print_ID_vals_id_1_166,#0x00
00103$:
	clr	c
	mov	a,_print_ID_vals_id_1_166
	subb	a,r6
	jc	00114$
	ret
00114$:
...
00115$:
	...
	movx	a,@dptr
	push	acc
	mov	dpl,_print_ID_vals_id_1_166
	ret
00116$:
	mov	r1,dpl
	mov	r2,dph
...
00118$:
	...
	pop	ar4
	pop	ar6
	mov	r6,_print_ID_vals_id_1_166
	mov	r7,#0x00
