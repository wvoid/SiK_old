...
_radio_transmit_simple_transmit_started_1_172:
	.ds 1
_radio_transmit_ret_1_188:
	.ds 1
_radio_transmit_EX0_saved_1_188:
	.ds 1
...
_scale_uint32_PARM_2:
	.ds 4
_scale_uint32_value_1_243:
	.ds 4
_set_frequency_registers_frequency_1_251:
	.ds 4
;--------------------------------------------------------
; external ram data
;--------------------------------------------------------
...
_radio_buffer::
	.ds 252
_radio_receive_packet_length_1_145:
	.ds 3
_radio_transmit_length_1_187:
	.ds 1
_radio_set_channel_channel_1_201:
	.ds 1
_radio_set_transmit_power_power_1_225:
	.ds 1
_radio_set_network_id_id_1_231:
	.ds 2
_set_frequency_registers_band_1_252:
	.ds 1
_radio_set_diversity_state_1_257:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;length                    Allocated with name '_radio_receive_packet_length_1_145'
;------------------------------------------------------------
...
_radio_receive_packet:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_radio_receive_packet_length_1_145
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;length                    Allocated with name '_radio_transmit_length_1_187'
;------------------------------------------------------------
...
_radio_transmit:
	mov	a,dpl
	mov	dptr,#_radio_transmit_length_1_187
	movx	@dptr,a
;	radio/radio.c:507: EX0_SAVE_DISABLE;
	mov	c,_EX0
	mov	_radio_transmit_EX0_saved_1_188,c
	clr	_EX0
...
;------------------------------------------------------------
;status                    Allocated with name '_radio_initialise_status_1_192'
;------------------------------------------------------------
...
;------------------------------------------------------------
;channel                   Allocated with name '_radio_set_channel_channel_1_201'
;------------------------------------------------------------
...
_radio_set_channel:
	mov	a,dpl
	mov	dptr,#_radio_set_channel_channel_1_201
	movx	@dptr,a
...
;------------------------------------------------------------
;power                     Allocated with name '_radio_set_transmit_power_power_1_225'
;i                         Allocated with name '_radio_set_transmit_power_i_1_226'
;------------------------------------------------------------
...
_radio_set_transmit_power:
	mov	a,dpl
	mov	dptr,#_radio_set_transmit_power_power_1_225
	movx	@dptr,a
...
;------------------------------------------------------------
;id                        Allocated with name '_radio_set_network_id_id_1_231'
;------------------------------------------------------------
...
_radio_set_network_id:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_radio_set_network_id_id_1_231
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
_scale_uint32:
	...
	mov	r5,b
	mov	r4,a
	mov	r0,#_scale_uint32_value_1_243
	mov	a,r7
	movx	@r0,a
	inc	r0
	mov	a,r6
...
;------------------------------------------------------------
;status                    Allocated with name '_software_reset_status_1_246'
;------------------------------------------------------------
...
;------------------------------------------------------------
;band                      Allocated with name '_set_frequency_registers_band_1_252'
;carrier                   Allocated with name '_set_frequency_registers_carrier_1_252'
;------------------------------------------------------------
...
_set_frequency_registers:
	...
	mov	r5,b
	mov	r4,a
	mov	r0,#_set_frequency_registers_frequency_1_251
	mov	a,r7
	movx	@r0,a
	inc	r0
	mov	a,r6
...
;	radio/radio.c:1111: frequency -= 480000000UL;
	mov	r0,#(_set_frequency_registers_frequency_1_251 + 1)
	movx	a,@r0
	add	a,#0xC8
	movx	@r0,a
	inc	r0
...
;	radio/radio.c:1112: band  = frequency / 20000000UL;
	...
	lcall	__divulong
	mov	r2,dpl
	mov	dptr,#_set_frequency_registers_band_1_252
	mov	a,r2
	movx	@dptr,a
...
;------------------------------------------------------------
;state                     Allocated with name '_radio_set_diversity_state_1_257'
;------------------------------------------------------------
...
_radio_set_diversity:
	mov	a,dpl
	mov	dptr,#_radio_set_diversity_state_1_257
	movx	@dptr,a
