...
_shuffle_PARM_2:
	.ds 1
_shuffle_array_1_136:
	.ds 2
_fhop_init_array_3_146:
	.ds 2
;--------------------------------------------------------
...
;array                     Allocated with name '_shuffle_array_1_136'
;i                         Allocated with name '_shuffle_i_1_137'
;j                         Allocated with name '_shuffle_j_2_138'
;t                         Allocated with name '_shuffle_t_2_138'
;------------------------------------------------------------
...
;	radio/freq_hopping.c:78: srand(param_get(PARAM_NETID));
	...
	lcall	_param_get
	lcall	_srand
;	radio/freq_hopping.c:80: if (param_get(PARAM_ENCRYPTION)) {
	mov	dpl,#0x10
	lcall	_param_get
	mov	r4,dpl
	mov	r5,dph
	...
	orl	a,r7
	jz	00103$
;	radio/freq_hopping.c:81: srand(crc16(32, param_get_encryption_key()));
	lcall	_param_get_encryption_key
	mov	_crc16_PARM_2,dpl
	mov	(_crc16_PARM_2 + 1),dph
	mov	dpl,#0x20
	lcall	_crc16
	mov  r7,dph
	ljmp	_srand
...
;i                         Allocated with name '_fhop_init_i_1_143'
;__00020001                Allocated with name '_fhop_init___00020001_3_146'
;__00020002                Allocated with name '_fhop_init___00020002_3_146'
;array                     Allocated with name '_fhop_init_array_3_146'
;n                         Allocated with name '_fhop_init_n_3_146'
;i                         Allocated with name '_fhop_init_i_4_147'
;j                         Allocated with name '_fhop_init_j_5_148'
;t                         Allocated with name '_fhop_init_t_5_148'
;------------------------------------------------------------
