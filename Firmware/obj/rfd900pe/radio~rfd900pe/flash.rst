      ...
      0000B4                        802 _flash_write_scratch_PARM_2:
      0000B4                        803 	.ds 1
                                    804 ;--------------------------------------------------------
      ...
      003C1C 75 B7 A5         [24]  859 	mov	_FLKEY,#0xA5
                                    860 ;	radio/flash.c:56: FLKEY = 0xf1;
      003C1F 75 B7 F1         [24]  861 	mov	_FLKEY,#0xF1
      003C22 22               [24]  862 	ret
                                    863 ;------------------------------------------------------------
                                    ...
                                    869 ;	-----------------------------------------
      003C23                        870 _flash_erase_scratch:
      003C23 D3               [12]  871 	setb	c
      003C24 10 AF 01         [24]  872 	jbc	ea,00103$
      003C27 C3               [12]  873 	clr	c
      003C28                        874 00103$:
      003C28 C0 D0            [24]  875 	push	psw
                                    876 ;	radio/flash.c:64: __pdata uint8_t	bank_state = PSBANK;
      003C2A AF 84            [24]  877 	mov	r7,_PSBANK
                                    878 ;	radio/flash.c:65: PSBANK = ((bank_state & 0x03) | 0x30); // Select Bank 3
      003C2C 74 03            [12]  879 	mov	a,#0x03
      003C2E 5F               [12]  880 	anl	a,r7
      003C2F 44 30            [12]  881 	orl	a,#0x30
      003C31 F5 84            [12]  882 	mov	_PSBANK,a
                                    883 ;	radio/flash.c:68: flash_load_keys();				// unlock flash for one operation
      003C33 C0 07            [24]  884 	push	ar7
      003C35 12 3C 1C         [24]  885 	lcall	_flash_load_keys
      003C38 D0 07            [24]  886 	pop	ar7
                                    887 ;	radio/flash.c:69: PSCTL = FLASH_ERASE_SCRATCH;	// enable flash erase of the scratch page
      003C3A 75 8F 03         [24]  888 	mov	_PSCTL,#0x03
                                    889 ;	radio/flash.c:70: *(uint8_t __xdata *)FLASH_SCRATCH = 0xff;	// trigger the erase
      003C3D 90 F8 00         [24]  890 	mov	dptr,#0xF800
      003C40 74 FF            [12]  891 	mov	a,#0xFF
      003C42 F0               [24]  892 	movx	@dptr,a
                                    893 ;	radio/flash.c:71: PSCTL = FLASH_DISABLE;			// disable flash write & scratch access
      003C43 75 8F 00         [24]  894 	mov	_PSCTL,#0x00
                                    895 ;	radio/flash.c:74: PSBANK = bank_state;
      003C46 8F 84            [24]  896 	mov	_PSBANK,r7
      003C48 D0 D0            [24]  897 	pop	psw
      003C4A 92 AF            [24]  898 	mov	ea,c
      003C4C 22               [24]  899 	ret
                                    900 ;------------------------------------------------------------
                                    901 ;Allocation info for local variables in function 'flash_read_scratch'
                                    902 ;------------------------------------------------------------
                                    903 ;d                         Allocated with name '_flash_read_scratch_d_1_134'
                                    904 ;------------------------------------------------------------
                                    905 ;	radio/flash.c:79: flash_read_scratch(__pdata uint16_t address)
                                    906 ;	-----------------------------------------
                                    907 ;	 function flash_read_scratch
                                    908 ;	-----------------------------------------
      003C4D                        909 _flash_read_scratch:
      003C4D D3               [12]  910 	setb	c
      003C4E 10 AF 01         [24]  911 	jbc	ea,00103$
      003C51 C3               [12]  912 	clr	c
      003C52                        913 00103$:
      003C52 C0 D0            [24]  914 	push	psw
      003C54 AE 82            [24]  915 	mov	r6,dpl
      003C56 AF 83            [24]  916 	mov	r7,dph
                                    917 ;	radio/flash.c:84: __pdata uint8_t	bank_state = PSBANK;
      003C58 AD 84            [24]  918 	mov	r5,_PSBANK
                                    919 ;	radio/flash.c:85: PSBANK = ((bank_state & 0x03) | 0x30); // Select Bank 3
      003C5A 74 03            [12]  920 	mov	a,#0x03
      003C5C 5D               [12]  921 	anl	a,r5
      003C5D 44 30            [12]  922 	orl	a,#0x30
      003C5F F5 84            [12]  923 	mov	_PSBANK,a
                                    924 ;	radio/flash.c:88: PSCTL = FLASH_READ_SCRATCH;
      003C61 75 8F 00         [24]  925 	mov	_PSCTL,#0x00
                                    926 ;	radio/flash.c:89: d = *(uint8_t __code *)(FLASH_SCRATCH | address);
      003C64 43 07 F8         [24]  927 	orl	ar7,#0xF8
      003C67 8E 82            [24]  928 	mov	dpl,r6
      003C69 8F 83            [24]  929 	mov	dph,r7
      003C6B E4               [12]  930 	clr	a
      003C6C 93               [24]  931 	movc	a,@a+dptr
      003C6D FF               [12]  932 	mov	r7,a
                                    933 ;	radio/flash.c:90: PSCTL = FLASH_DISABLE;
      003C6E 75 8F 00         [24]  934 	mov	_PSCTL,#0x00
                                    935 ;	radio/flash.c:93: PSBANK = bank_state;
      003C71 8D 84            [24]  936 	mov	_PSBANK,r5
                                    937 ;	radio/flash.c:95: return d;
      003C73 8F 82            [24]  938 	mov	dpl,r7
      003C75 D0 D0            [24]  939 	pop	psw
      003C77 92 AF            [24]  940 	mov	ea,c
      003C79 22               [24]  941 	ret
                                    942 ;------------------------------------------------------------
                                    ...
                                    948 ;	-----------------------------------------
      003C7A                        949 _flash_write_scratch:
      003C7A D3               [12]  950 	setb	c
      003C7B 10 AF 01         [24]  951 	jbc	ea,00103$
      003C7E C3               [12]  952 	clr	c
      003C7F                        953 00103$:
      003C7F C0 D0            [24]  954 	push	psw
      003C81 AE 82            [24]  955 	mov	r6,dpl
      003C83 AF 83            [24]  956 	mov	r7,dph
                                    957 ;	radio/flash.c:102: __pdata uint8_t	bank_state = PSBANK;
      003C85 AD 84            [24]  958 	mov	r5,_PSBANK
                                    959 ;	radio/flash.c:103: PSBANK = ((bank_state & 0x03) | 0x30); // Select Bank 3
      003C87 74 03            [12]  960 	mov	a,#0x03
      003C89 5D               [12]  961 	anl	a,r5
      003C8A 44 30            [12]  962 	orl	a,#0x30
      003C8C F5 84            [12]  963 	mov	_PSBANK,a
                                    964 ;	radio/flash.c:106: flash_load_keys();
      003C8E C0 07            [24]  965 	push	ar7
      003C90 C0 06            [24]  966 	push	ar6
      003C92 C0 05            [24]  967 	push	ar5
      003C94 12 3C 1C         [24]  968 	lcall	_flash_load_keys
      003C97 D0 05            [24]  969 	pop	ar5
      003C99 D0 06            [24]  970 	pop	ar6
      003C9B D0 07            [24]  971 	pop	ar7
                                    972 ;	radio/flash.c:107: PSCTL = 0x05;
      003C9D 75 8F 05         [24]  973 	mov	_PSCTL,#0x05
                                    974 ;	radio/flash.c:108: *(uint8_t __xdata *)(FLASH_SCRATCH | address) = c;
      003CA0 43 07 F8         [24]  975 	orl	ar7,#0xF8
      003CA3 8E 82            [24]  976 	mov	dpl,r6
      003CA5 8F 83            [24]  977 	mov	dph,r7
      003CA7 78 B4            [12]  978 	mov	r0,#_flash_write_scratch_PARM_2
      003CA9 E2               [24]  979 	movx	a,@r0
      003CAA F0               [24]  980 	movx	@dptr,a
                                    981 ;	radio/flash.c:111: PSBANK = bank_state;
      003CAB 8D 84            [24]  982 	mov	_PSBANK,r5
                                    983 ;	radio/flash.c:113: PSCTL = FLASH_DISABLE;
      003CAD 75 8F 00         [24]  984 	mov	_PSCTL,#0x00
      003CB0 D0 D0            [24]  985 	pop	psw
      003CB2 92 AF            [24]  986 	mov	ea,c
      003CB4 22               [24]  987 	ret
                                    988 	.area CSEG    (CODE)
                                    989 	.area CONST   (CODE)
                                    990 	.area XINIT   (CODE)
