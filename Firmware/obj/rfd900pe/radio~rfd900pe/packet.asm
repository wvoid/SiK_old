...
; This file was generated Wed Sep  7 10:05:10 2022
;--------------------------------------------------------
	.module packet
...
;--------------------------------------------------------
	.area DSEG    (DATA)
_mavlink_frame_slen_1_154:
	.ds 2
_mavlink_frame_c_2_155:
	.ds 1
_mavlink_frame_extra_len_2_155:
	.ds 1
...
_encryptReturn_sloc0_1_0:
	.ds 3
_packet_get_next_slen_1_166:
	.ds 2
_packet_get_next_c_2_183:
	.ds 1
...
_encryptReturn_PARM_3:
	.ds 1
_encryptReturn_buf_out_1_161:
	.ds 2
_packet_get_next_PARM_2:
	.ds 2
_packet_set_max_xmit_max_1_200:
	.ds 1
_packet_set_serial_speed_speed_1_202:
	.ds 2
_packet_is_duplicate_PARM_2:
	.ds 2
_packet_is_duplicate_len_1_204:
	.ds 1
_packet_inject_buf_1_208:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;slen                      Allocated with name '_mavlink_frame_slen_1_154'
;c                         Allocated with name '_mavlink_frame_c_2_155'
;extra_len                 Allocated with name '_mavlink_frame_extra_len_2_155'
...
;max_xmit                  Allocated with name '_mavlink_frame_max_xmit_1_153'
;------------------------------------------------------------
...
_mavlink_frame:
	mov	a,dpl
	mov	dptr,#_mavlink_frame_max_xmit_1_153
	movx	@dptr,a
...
;	radio/packet.c:108: slen = serial_read_available();
	...
	mov	_mavlink_frame_slen_1_154,dpl
	mov	(_mavlink_frame_slen_1_154 + 1),dph
...
00113$:
	clr	c
	mov	a,_mavlink_frame_slen_1_154
	subb	a,#0x08
	mov	a,(_mavlink_frame_slen_1_154 + 1)
	subb	a,#0x00
	jnc	00145$
	ljmp	00115$
00145$:
;	radio/packet.c:113: register uint8_t c = serial_peekx(0);
	...
	push	ar5
	lcall	_serial_peekx
	mov	_mavlink_frame_c_2_155,dpl
	pop	ar5
;	radio/packet.c:114: register uint8_t extra_len = 8;
	mov	_mavlink_frame_extra_len_2_155,#0x08
;	radio/packet.c:115: if (c != MAVLINK10_STX && c != MAVLINK20_STX) {
	mov	a,#0xFE
	cjne	a,_mavlink_frame_c_2_155,00146$
	sjmp	00102$
00146$:
	mov	a,#0xFD
	cjne	a,_mavlink_frame_c_2_155,00147$
	sjmp	00102$
00147$:
...
;	radio/packet.c:119: if (c == MAVLINK20_STX) {
	mov	a,#0xFD
	cjne	a,_mavlink_frame_c_2_155,00107$
;	radio/packet.c:120: extra_len += 4;
	mov	a,_mavlink_frame_extra_len_2_155
	add	a,#0x04
	mov	_mavlink_frame_extra_len_2_155,a
...
;	radio/packet.c:123: extra_len += 13;
	mov	a,#0x0D
	add	a,_mavlink_frame_extra_len_2_155
	mov	_mavlink_frame_extra_len_2_155,a
00107$:
...
;	radio/packet.c:128: if (c >= 255 - extra_len || 
	mov	_mavlink_frame_sloc0_1_0,_mavlink_frame_extra_len_2_155
	...
	mov	r7,a
	mov	_mavlink_frame_sloc1_1_0,_mavlink_frame_c_2_155
...
;	radio/packet.c:139: c += extra_len;
	mov	a,_mavlink_frame_extra_len_2_155
	add	a,_mavlink_frame_c_2_155
	mov	_mavlink_frame_c_2_155,a
...
;	radio/packet.c:148: slen -= c;
	mov	r4,_mavlink_frame_c_2_155
	mov	r7,#0x00
	mov	a,_mavlink_frame_slen_1_154
	clr	c
	subb	a,r4
	mov	_mavlink_frame_slen_1_154,a
	mov	a,(_mavlink_frame_slen_1_154 + 1)
	subb	a,r7
	mov	(_mavlink_frame_slen_1_154 + 1),a
	ljmp	00113$
00115$:
...
;buf_out                   Allocated with name '_encryptReturn_buf_out_1_161'
;------------------------------------------------------------
...
_encryptReturn:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_encryptReturn_buf_out_1_161
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	radio/packet.c:161: if (aes_get_encryption_level() > 0) {
	lcall	_aes_get_encryption_level
	mov	a,dpl
	jz	00104$
;	radio/packet.c:162: if (aes_encrypt(buf_in, buf_in_len, buf_out, &len_encrypted) != 0)
	...
	mov	a,#_len_encrypted
	movx	@dptr,a
	mov	a,#(_len_encrypted >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
	...
	mov	a,dpl
	jz	00102$
;	radio/packet.c:164: panic("error while trying to encrypt data");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
00102$:
;	radio/packet.c:166: return len_encrypted;
	mov	dptr,#_len_encrypted
	movx	a,@dptr
	mov	dpl,a
	ret
00104$:
...
;slen                      Allocated with name '_packet_get_next_slen_1_166'
;c                         Allocated with name '_packet_get_next_c_2_183'
...
_packet_get_next:
	mov	r7,dpl
;	radio/packet.c:185: if (aes_get_encryption_level() > 0) {
	push	ar7
	lcall	_aes_get_encryption_level
	mov	a,dpl
	pop	ar7
	jz	00108$
;	radio/packet.c:186: if(max_xmit <= 16) return 0;
	mov	a,r7
	add	a,#0xff - 0x10
	jc	00102$
	mov	dpl,#0x00
	ret
00102$:
;	radio/packet.c:187: if(max_xmit <= 32) max_xmit = 15;
	mov	a,r7
	add	a,#0xff - 0x20
	jc	00104$
	mov	r7,#0x0F
00104$:
;	radio/packet.c:188: if(max_xmit > 31 ) max_xmit = 31;
	mov	a,r7
	add	a,#0xff - 0x1F
	jnc	00108$
	mov	r7,#0x1F
...
;	radio/packet.c:194: slen = last_sent_len;
	...
	movx	a,@dptr
	mov	r6,a
	mov	_packet_get_next_slen_1_166,r6
	mov	(_packet_get_next_slen_1_166 + 1),#0x00
...
;	radio/packet.c:202: if (max_xmit < slen) {
	...
	clr	c
	mov	a,r2
	subb	a,_packet_get_next_slen_1_166
	mov	a,r3
	subb	a,(_packet_get_next_slen_1_166 + 1)
	jnc	00112$
;	radio/packet.c:204: last_sent_len = slen - max_xmit;
	mov	r3,_packet_get_next_slen_1_166
	mov	dptr,#_last_sent_len
	mov	a,r3
	clr	c
	subb	a,r7
...
;	radio/packet.c:205: slen = encryptReturn(buf, last_sent, max_xmit);
	...
	mov	r3,dpl
	pop	ar7
	mov	_packet_get_next_slen_1_166,r3
	mov	(_packet_get_next_slen_1_166 + 1),#0x00
...
;	radio/packet.c:209: return slen;
	mov	r4,_packet_get_next_slen_1_166
	mov	dpl,r4
	ret
00112$:
...
;	radio/packet.c:219: slen = serial_read_available();
	push	ar7
	lcall	_serial_read_available
	mov	_packet_get_next_slen_1_166,dpl
	mov	(_packet_get_next_slen_1_166 + 1),dph
	pop	ar7
;	radio/packet.c:220: if (force_resend) {
	jnb	_force_resend,00118$
...
;	radio/packet.c:234: slen = max_xmit;
	mov	_packet_get_next_slen_1_166,r5
	mov	(_packet_get_next_slen_1_166 + 1),r6
00120$:
...
;	radio/packet.c:239: if (slen == 0) {
	mov	a,_packet_get_next_slen_1_166
	orl	a,(_packet_get_next_slen_1_166 + 1)
...
;	radio/packet.c:257: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_166,00276$
	clr	a
	cjne	a,(_packet_get_next_slen_1_166 + 1),00276$
	sjmp	00277$
00276$:
	sjmp	00131$
00277$:
...
;	radio/packet.c:274: if (slen < mav_pkt_len) {
	...
	mov	a,_packet_get_next_slen_1_166
	subb	a,r5
	mov	a,(_packet_get_next_slen_1_166 + 1)
	subb	a,r6
	jnc	00137$
...
;	radio/packet.c:294: register uint8_t c = serial_peekx(0);
	...
	push	ar7
	lcall	_serial_peekx
	mov	_packet_get_next_c_2_183,dpl
	pop	ar7
;	radio/packet.c:295: if (c == MAVLINK10_STX || c == MAVLINK20_STX) {
	mov	a,#0xFE
	cjne	a,_packet_get_next_c_2_183,00283$
	sjmp	00158$
00283$:
	mov	a,#0xFD
	cjne	a,_packet_get_next_c_2_183,00284$
	sjmp	00285$
00284$:
	ljmp	00159$
00285$:
...
;	radio/packet.c:296: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_166,00286$
	clr	a
	cjne	a,(_packet_get_next_slen_1_166 + 1),00286$
	sjmp	00287$
00286$:
	sjmp	00143$
00287$:
...
;	radio/packet.c:314: slen--;				
	dec	_packet_get_next_slen_1_166
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_166,00292$
	dec	(_packet_get_next_slen_1_166 + 1)
00292$:
...
;	radio/packet.c:321: if (c == MAVLINK20_STX) {
	mov	a,#0xFD
	cjne	a,_packet_get_next_c_2_183,00151$
...
;	radio/packet.c:350: slen--;
	dec	_packet_get_next_slen_1_166
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_166,00299$
	dec	(_packet_get_next_slen_1_166 + 1)
00299$:
	ljmp	00162$
00164$:
...
;------------------------------------------------------------
;max                       Allocated with name '_packet_set_max_xmit_max_1_200'
;------------------------------------------------------------
...
_packet_set_max_xmit:
	mov	a,dpl
	mov	dptr,#_packet_set_max_xmit_max_1_200
	movx	@dptr,a
...
;------------------------------------------------------------
;speed                     Allocated with name '_packet_set_serial_speed_speed_1_202'
;------------------------------------------------------------
...
_packet_set_serial_speed:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_packet_set_serial_speed_speed_1_202
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;len                       Allocated with name '_packet_is_duplicate_len_1_204'
;------------------------------------------------------------
...
_packet_is_duplicate:
	mov	a,dpl
	mov	dptr,#_packet_is_duplicate_len_1_204
	movx	@dptr,a
...
;------------------------------------------------------------
;buf                       Allocated with name '_packet_inject_buf_1_208'
;------------------------------------------------------------
...
_packet_inject:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_packet_inject_buf_1_208
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/packet.c:432: injected_packet = true;
	...
	.area CONST   (CODE)
___str_0:
	.ascii "error while trying to encrypt data"
	.db 0x00
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
