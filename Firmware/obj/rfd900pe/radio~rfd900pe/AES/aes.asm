...
_encryption_level::
	.ds 1
_aes_set_encryption_level_encryption_1_136:
	.ds 1
_aesCopyInit2_PARM_2:
	.ds 2
_aesCopyInit2_dest_1_139:
	.ds 2
_aes_init_encryption_level_1_142:
	.ds 1
_aes_pad_PARM_2:
	.ds 1
_aes_pad_in_str_1_145:
	.ds 2
_aes_pad_pad_length_1_146:
	.ds 1
_aes_encrypt_PARM_2:
	.ds 1
_aes_encrypt_PARM_3:
...
_aes_encrypt_PARM_4:
	.ds 3
_aes_encrypt_in_str_1_148:
	.ds 2
_aes_encrypt_key_size_code_1_149:
	.ds 1
_aes_encrypt_status_1_149:
	.ds 1
_aes_decrypt_PARM_2:
	.ds 1
_aes_decrypt_PARM_3:
...
_aes_decrypt_PARM_4:
	.ds 3
_aes_decrypt_in_str_1_152:
	.ds 2
_aes_decrypt_key_size_code_1_153:
	.ds 1
_aes_decrypt_status_1_153:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;encryption                Allocated with name '_aes_set_encryption_level_encryption_1_136'
;------------------------------------------------------------
...
_aes_set_encryption_level:
	mov	a,dpl
	mov	dptr,#_aes_set_encryption_level_encryption_1_136
	movx	@dptr,a
...
;dest                      Allocated with name '_aesCopyInit2_dest_1_139'
;i                         Allocated with name '_aesCopyInit2_i_1_140'
;------------------------------------------------------------
...
_aesCopyInit2:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_aesCopyInit2_dest_1_139
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;encryption_level          Allocated with name '_aes_init_encryption_level_1_142'
;crypto_type               Allocated with name '_aes_init_crypto_type_1_143'
;status                    Allocated with name '_aes_init_status_1_143'
;key_size_code             Allocated with name '_aes_init_key_size_code_1_143'
;bits                      Allocated with name '_aes_init_bits_1_143'
;------------------------------------------------------------
...
_aes_init:
	mov	a,dpl
	mov	dptr,#_aes_init_encryption_level_1_142
	movx	@dptr,a
...
;in_str                    Allocated with name '_aes_pad_in_str_1_145'
;pad_length                Allocated with name '_aes_pad_pad_length_1_146'
;i                         Allocated with name '_aes_pad_i_1_146'
;------------------------------------------------------------
...
_aes_pad:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_aes_pad_in_str_1_145
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/AES/aes.c:179: pad_length = 16 - (len%16);
	mov	a,#0x0F
	anl	a,r4
	mov	dptr,#_aes_pad_pad_length_1_146
	setb	c
	subb	a,#0x10
	cpl	a
	movx	@dptr,a
...
;	radio/AES/aes.c:182: memcpy(&encrypt_packet[len+i], &pad_length, sizeof(pad_length));
	...
	mov	r3,#0x00
	mov	dptr,#_memcpy_PARM_2
	mov	a,#_aes_pad_pad_length_1_146
	movx	@dptr,a
	mov	a,#(_aes_pad_pad_length_1_146 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;in_str                    Allocated with name '_aes_encrypt_in_str_1_148'
;encryption                Allocated with name '_aes_encrypt_encryption_1_149'
;crypto_type               Allocated with name '_aes_encrypt_crypto_type_1_149'
;key_size_code             Allocated with name '_aes_encrypt_key_size_code_1_149'
;status                    Allocated with name '_aes_encrypt_status_1_149'
;blocks                    Allocated with name '_aes_encrypt_blocks_1_149'
;pt                        Allocated with name '_aes_encrypt_pt_1_149'
;------------------------------------------------------------
...
_aes_encrypt:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_aes_encrypt_in_str_1_148
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/AES/aes.c:214: key_size_code = ENCRYPTION_128_BITS;
	mov	dptr,#_aes_encrypt_key_size_code_1_149
	mov	a,#0x04
	movx	@dptr,a
...
;	radio/AES/aes.c:249: status = CBC_EncryptDecrypt (key_size_code, pt, out_str, InitialVector, EncryptionKey, blocks);
	...
	mov	a,dpl
	pop	ar7
	mov	dptr,#_aes_encrypt_status_1_149
	movx	@dptr,a
...
;in_str                    Allocated with name '_aes_decrypt_in_str_1_152'
;encryption                Allocated with name '_aes_decrypt_encryption_1_153'
;crypto_type               Allocated with name '_aes_decrypt_crypto_type_1_153'
;key_size_code             Allocated with name '_aes_decrypt_key_size_code_1_153'
;status                    Allocated with name '_aes_decrypt_status_1_153'
;blocks                    Allocated with name '_aes_decrypt_blocks_1_153'
;ct                        Allocated with name '_aes_decrypt_ct_1_153'
;------------------------------------------------------------
...
_aes_decrypt:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_aes_decrypt_in_str_1_152
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/AES/aes.c:295: key_size_code = DECRYPTION_128_BITS;
	mov	dptr,#_aes_decrypt_key_size_code_1_153
	clr	a
	movx	@dptr,a
...
;	radio/AES/aes.c:324: status = CBC_EncryptDecrypt (key_size_code, out_str, ct, InitialVector, DecryptionKey, blocks);
	...
	pop	ar5
	pop	ar7
	mov	dptr,#_aes_decrypt_status_1_153
	movx	@dptr,a
