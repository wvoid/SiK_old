...
_convert_to_hex_PARM_2:
	.ds 2
_convert_to_hex_str_in_1_195:
	.ds 2
_param_set_default_encryption_key_b_1_199:
	.ds 1
_param_set_encryption_key_key_1_201:
	.ds 2
;--------------------------------------------------------
...
;str_in                    Allocated with name '_convert_to_hex_str_in_1_195'
;------------------------------------------------------------
...
_convert_to_hex:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_convert_to_hex_str_in_1_195
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	radio/parameters.c:523: for (i=0;i<key_length;i++) {
	...
	mov	r0,#_convert_to_hex_i_1_196
	clr	a
	movx	@r0,a
00103$:
	mov	r0,#_convert_to_hex_i_1_196
...
;------------------------------------------------------------
;b                         Allocated with name '_param_set_default_encryption_key_b_1_199'
;------------------------------------------------------------
...
;	radio/parameters.c:535: __xdata uint8_t b[] = {0x62};
	mov	dptr,#_param_set_default_encryption_key_b_1_199
	mov	a,#0x62
	movx	@dptr,a
...
;	radio/parameters.c:539: memcpy(&encryption_key[i], &b, 1);
	...
	mov	a,#_param_set_default_encryption_key_b_1_199
	movx	@dptr,a
	mov	a,#(_param_set_default_encryption_key_b_1_199 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;key                       Allocated with name '_param_set_encryption_key_key_1_201'
;------------------------------------------------------------
...
_param_set_encryption_key:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_param_set_encryption_key_key_1_201
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
