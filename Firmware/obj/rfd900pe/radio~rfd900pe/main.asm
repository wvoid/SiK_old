...
; This file was generated Sun Sep 18 12:40:51 2022
;--------------------------------------------------------
	.module main
...
_feature_mavlink_framing::
	.ds 1
_radio_init_freq_min_1_171:
	.ds 4
_radio_init_freq_max_1_171:
	.ds 4
_radio_init_channel_spacing_1_171:
	.ds 4
_radio_init_txpower_1_171:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;i                         Allocated with name '_hardware_init_i_1_169'
;------------------------------------------------------------
...
;freq_min                  Allocated with name '_radio_init_freq_min_1_171'
;freq_max                  Allocated with name '_radio_init_freq_max_1_171'
;channel_spacing           Allocated with name '_radio_init_channel_spacing_1_171'
;txpower                   Allocated with name '_radio_init_txpower_1_171'
;------------------------------------------------------------
...
;	radio/main.c:300: freq_min = 433050000UL;
	mov	dptr,#_radio_init_freq_min_1_171
	mov	a,#0x90
	movx	@dptr,a
	mov	a,#0xD1
	inc	dptr
...
;	radio/main.c:301: freq_max = 434790000UL;
	mov	dptr,#_radio_init_freq_max_1_171
	mov	a,#0x70
	movx	@dptr,a
	mov	a,#0x5E
	inc	dptr
...
;	radio/main.c:302: txpower = 10;
	mov	dptr,#_radio_init_txpower_1_171
	mov	a,#0x0A
	movx	@dptr,a
...
;	radio/main.c:393: channel_spacing = (freq_max - freq_min) / (num_fh_channels+2);
	...
	mov	r6,b
	mov	r7,a
	mov	dptr,#_radio_init_channel_spacing_1_171
	mov	a,r4
	movx	@dptr,a
	mov	a,r5
	inc	dptr
