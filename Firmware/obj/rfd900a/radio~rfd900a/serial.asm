...
_serial_write_buf_sloc0_1_0:
	.ds 1
_serial_write_space_ES_saved_1_188:
	.ds 1
_serial_read_ES_saved_1_193:
	.ds 1
_serial_peek_ES_saved_1_199:
	.ds 1
_serial_peekx_ES_saved_1_201:
	.ds 1
_serial_read_buf_sloc1_1_0:
	.ds 1
_serial_read_available_ES_saved_1_213:
	.ds 1
;--------------------------------------------------------
...
_rts_count:
	.ds 1
_serial_write_buf_buf_1_175:
	.ds 2
_serial_peekx_offset_1_200:
	.ds 2
_serial_read_buf_buf_1_202:
	.ds 2
_serial_device_set_speed_i_1_223:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;buf                       Allocated with name '_serial_write_buf_buf_1_175'
;------------------------------------------------------------
...
_serial_write_buf:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_write_buf_buf_1_175
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/serial.c:408: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_write_space_ES_saved_1_188,c
	clr	_ES0
...
;	radio/serial.c:410: ES0_RESTORE;
	mov	c,_serial_write_space_ES_saved_1_188
	mov	_ES0,c
...
;	radio/serial.c:433: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_ES_saved_1_193,c
	clr	_ES0
...
;	radio/serial.c:447: ES0_RESTORE;
	mov	c,_serial_read_ES_saved_1_193
	mov	_ES0,c
...
;	radio/serial.c:457: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peek_ES_saved_1_199,c
	clr	_ES0
...
;	radio/serial.c:459: ES0_RESTORE;
	mov	c,_serial_peek_ES_saved_1_199
	mov	_ES0,c
...
;------------------------------------------------------------
;c                         Allocated to registers r7 
;offset                    Allocated with name '_serial_peekx_offset_1_200'
;------------------------------------------------------------
...
_serial_peekx:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_peekx_offset_1_200
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	radio/serial.c:469: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peekx_ES_saved_1_201,c
	clr	_ES0
...
;	radio/serial.c:471: ES0_RESTORE;
	mov	c,_serial_peekx_ES_saved_1_201
	mov	_ES0,c
...
;buf                       Allocated with name '_serial_read_buf_buf_1_202'
;------------------------------------------------------------
...
_serial_read_buf:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_serial_read_buf_buf_1_202
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	radio/serial.c:525: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_available_ES_saved_1_213,c
	clr	_ES0
...
;	radio/serial.c:527: ES0_RESTORE;
	mov	c,_serial_read_available_ES_saved_1_213
	mov	_ES0,c
...
;------------------------------------------------------------
;space                     Allocated with name '_serial_read_space_space_1_215'
;------------------------------------------------------------
...
;------------------------------------------------------------
;i                         Allocated with name '_serial_device_valid_speed_i_1_219'
;num_rates                 Allocated with name '_serial_device_valid_speed_num_rates_1_219'
;speed                     Allocated to registers r7 
;------------------------------------------------------------
...
;------------------------------------------------------------
;speed                     Allocated to registers r7 
;i                         Allocated with name '_serial_device_set_speed_i_1_223'
;num_rates                 Allocated with name '_serial_device_set_speed_num_rates_1_223'
;------------------------------------------------------------
...
;	radio/serial.c:594: for (i = 0; i < num_rates; i++) {
	...
	sjmp	00107$
00115$:
	mov	dptr,#_serial_device_set_speed_i_1_223
	mov	a,r6
	movx	@dptr,a
