...
; This file was generated Sun Sep 18 12:39:56 2022
;--------------------------------------------------------
	.module main
...
;	radio/main.c:193: RSTSRC	 =  0x06;		// enable brown out and missing clock reset sources
	mov	_RSTSRC,#0x06
;	radio/main.c:200: P0SKIP  =  0xCF;				// P0 UART avail on XBAR
	mov	_P0SKIP,#0xCF
;	radio/main.c:201: P1SKIP  =  0xF8;				// P1 SPI1 avail on XBAR
	mov	_P1SKIP,#0xF8
;	radio/main.c:202: P2SKIP  =  0xCF;				// P2 CEX0 avail on XBAR P2.4, rest GPIO
	mov	_P2SKIP,#0xCF
...
;	radio/main.c:210: XBR0      =  0x01;		// UART enable
	mov	_XBR0,#0x01
;	radio/main.c:217: XBR1    |= 0x41;	// enable SPI in 3-wire mode + CEX0
	orl	_XBR1,#0x41
;	radio/main.c:218: P1MDOUT |= 0xF5;	// SCK1, MOSI1, MISO1 push-pull
	orl	_P1MDOUT,#0xF5
;	radio/main.c:219: P2MDOUT |= 0xFF;	// SCK1, MOSI1, MISO1 push-pull
	mov	a,_P2MDOUT
	mov	_P2MDOUT,#0xFF
