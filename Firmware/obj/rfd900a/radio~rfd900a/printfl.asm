...
;buf                       Allocated with name '_printf_start_capture_buf_1_1'
;------------------------------------------------------------
...
_printf_start_capture:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_printf_start_capture_buf_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
...
;buffer                    Allocated with name '_vprintfl_buffer_4_15'
;------------------------------------------------------------
