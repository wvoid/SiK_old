...
;--------------------------------------------------------
	.area	OSEG    (OVR,DATA)
_mavlink_crc_length_1_1:
	.ds 1
_mavlink_crc_tmp_2_2:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_mavlink_crc_sum_1_1:
	.ds 2
_MAVLink_report_m_1_1:
	.ds 3
;--------------------------------------------------------
...
;------------------------------------------------------------
;sum                       Allocated with name '_mavlink_crc_sum_1_1'
;i                         Allocated with name '_mavlink_crc_i_1_1'
;stoplen                   Allocated with name '_mavlink_crc_stoplen_1_1'
;crc_extra                 Allocated to registers r7 
;length                    Allocated with name '_mavlink_crc_length_1_1'
;tmp                       Allocated with name '_mavlink_crc_tmp_2_2'
;------------------------------------------------------------
...
;	radio/mavlink.c:57: register uint8_t length = pbuf[1];
	...
	movx	a,@dptr
	mov	_mavlink_crc_length_1_1,a
;	radio/mavlink.c:58: __xdata uint16_t sum = 0xFFFF;
	mov	dptr,#_mavlink_crc_sum_1_1
	mov	a,#0xFF
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
...
;	radio/mavlink.c:71: tmp ^= (tmp<<4);
	mov	_mavlink_crc_tmp_2_2,a
	swap	a
	anl	a,#0xF0
	xrl	_mavlink_crc_tmp_2_2,a
;	radio/mavlink.c:72: sum = (sum>>8) ^ (tmp<<8) ^ (tmp<<3) ^ (tmp>>4);
	mov	ar2,r3
	mov	r3,#0x00
	mov	r0,_mavlink_crc_tmp_2_2
	mov	r1,#0x00
	mov	ar6,r0
	clr	a
	xrl	ar2,a
...
;m                         Allocated with name '_MAVLink_report_m_1_1'
;------------------------------------------------------------
...
;	radio/mavlink.c:116: struct mavlink_RADIO_v10 *m = (struct mavlink_RADIO_v10 *)&pbuf[6];
	...
	mov	r5,#0x00
	mov	dptr,#_MAVLink_report_m_1_1
	mov	a,r6
	movx	@dptr,a
	inc	dptr
	mov	a,r7
...
;	radio/mavlink.c:127: m->rssi     = statistics.average_rssi;
	...
	addc	a,r6
	mov	(_MAVLink_report_sloc0_1_0 + 1),a
	mov	(_MAVLink_report_sloc0_1_0 + 2),r7
	mov	r0,#_statistics
	movx	a,@r0
	mov	dpl,_MAVLink_report_sloc0_1_0
	mov	dph,(_MAVLink_report_sloc0_1_0 + 1)
