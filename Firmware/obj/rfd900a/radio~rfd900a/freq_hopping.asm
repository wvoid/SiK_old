...
;array                     Allocated with name '_shuffle_array_1_1'
;i                         Allocated with name '_shuffle_i_1_1'
;j                         Allocated with name '_shuffle_j_2_2'
;t                         Allocated with name '_shuffle_t_2_2'
;------------------------------------------------------------
...
;i                         Allocated with name '_fhop_init_i_1_1'
;__00020001                Allocated with name '_fhop_init___00020001_3_4'
;__00020002                Allocated with name '_fhop_init___00020002_3_4'
;array                     Allocated with name '_fhop_init_array_3_4'
;n                         Allocated with name '_fhop_init_n_3_4'
;i                         Allocated with name '_fhop_init_i_4_5'
;j                         Allocated with name '_fhop_init_j_5_6'
;t                         Allocated with name '_fhop_init_t_5_6'
;------------------------------------------------------------
