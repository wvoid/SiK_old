...
;--------------------------------------------------------
	.area DSEG    (DATA)
_mavlink_frame_slen_1_1:
	.ds 2
_mavlink_frame_c_2_2:
	.ds 1
_mavlink_frame_extra_len_2_2:
	.ds 1
...
_encryptReturn_sloc0_1_0:
	.ds 3
_packet_get_next_slen_1_1:
	.ds 2
_packet_get_next_c_2_17:
	.ds 1
...
_last_recv_len:
	.ds 1
_mavlink_frame_max_xmit_1_1:
	.ds 1
_encryptReturn_PARM_2:
	.ds 2
_encryptReturn_PARM_3:
	.ds 1
_encryptReturn_buf_out_1_1:
	.ds 2
_packet_get_next_PARM_2:
	.ds 2
_packet_set_max_xmit_max_1_1:
	.ds 1
_packet_set_serial_speed_speed_1_1:
	.ds 2
_packet_is_duplicate_PARM_2:
	.ds 2
_packet_is_duplicate_len_1_1:
	.ds 1
_packet_inject_buf_1_1:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;slen                      Allocated with name '_mavlink_frame_slen_1_1'
;c                         Allocated with name '_mavlink_frame_c_2_2'
;extra_len                 Allocated with name '_mavlink_frame_extra_len_2_2'
...
;max_xmit                  Allocated with name '_mavlink_frame_max_xmit_1_1'
;------------------------------------------------------------
...
_mavlink_frame:
	mov	a,dpl
	mov	dptr,#_mavlink_frame_max_xmit_1_1
	movx	@dptr,a
...
;	radio/packet.c:108: slen = serial_read_available();
	...
	mov	_mavlink_frame_slen_1_1,dpl
	mov	(_mavlink_frame_slen_1_1 + 1),dph
...
00113$:
	clr	c
	mov	a,_mavlink_frame_slen_1_1
	subb	a,#0x08
	mov	a,(_mavlink_frame_slen_1_1 + 1)
	subb	a,#0x00
	jnc	00127$
	ljmp	00115$
00127$:
;	radio/packet.c:113: register uint8_t c = serial_peekx(0);
	...
	push	ar5
	lcall	_serial_peekx
	mov	_mavlink_frame_c_2_2,dpl
	pop	ar5
;	radio/packet.c:114: register uint8_t extra_len = 8;
	mov	_mavlink_frame_extra_len_2_2,#0x08
;	radio/packet.c:115: if (c != MAVLINK10_STX && c != MAVLINK20_STX) {
	mov	a,#0xFE
	cjne	a,_mavlink_frame_c_2_2,00128$
	sjmp	00102$
00128$:
	mov	a,#0xFD
	cjne	a,_mavlink_frame_c_2_2,00129$
	sjmp	00102$
00129$:
...
;	radio/packet.c:119: if (c == MAVLINK20_STX) {
	mov	a,#0xFD
	cjne	a,_mavlink_frame_c_2_2,00107$
;	radio/packet.c:120: extra_len += 4;
	mov	a,_mavlink_frame_extra_len_2_2
	add	a,#0x04
	mov	_mavlink_frame_extra_len_2_2,a
...
;	radio/packet.c:123: extra_len += 13;
	mov	a,#0x0D
	add	a,_mavlink_frame_extra_len_2_2
	mov	_mavlink_frame_extra_len_2_2,a
00107$:
...
;	radio/packet.c:128: if (c >= 255 - extra_len || 
	mov	_mavlink_frame_sloc0_1_0,_mavlink_frame_extra_len_2_2
	...
	mov	r7,a
	mov	_mavlink_frame_sloc1_1_0,_mavlink_frame_c_2_2
...
;	radio/packet.c:139: c += extra_len;
	mov	a,_mavlink_frame_extra_len_2_2
	add	a,_mavlink_frame_c_2_2
	mov	_mavlink_frame_c_2_2,a
...
;	radio/packet.c:148: slen -= c;
	...
	clr	c
	subb	a,r2
	mov	_mavlink_frame_slen_1_1,a
	mov	a,(_mavlink_frame_slen_1_1 + 1)
	subb	a,r7
	mov	(_mavlink_frame_slen_1_1 + 1),a
	ljmp	00113$
00115$:
...
;buf_out                   Allocated with name '_encryptReturn_buf_out_1_1'
;------------------------------------------------------------
...
_encryptReturn:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_encryptReturn_buf_out_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
;	radio/packet.c:171: memcpy(buf_out, buf_in, buf_in_len);
	...
	mov	(_encryptReturn_sloc0_1_0 + 2),#0x00
...
;slen                      Allocated with name '_packet_get_next_slen_1_1'
;c                         Allocated with name '_packet_get_next_c_2_17'
...
;	radio/packet.c:194: slen = last_sent_len;
	...
	movx	a,@dptr
	mov	r6,a
	mov	_packet_get_next_slen_1_1,r6
	mov	(_packet_get_next_slen_1_1 + 1),#0x00
...
;	radio/packet.c:202: if (max_xmit < slen) {
	...
	clr	c
	mov	a,r2
	subb	a,_packet_get_next_slen_1_1
	mov	a,r3
	subb	a,(_packet_get_next_slen_1_1 + 1)
	jnc	00104$
;	radio/packet.c:204: last_sent_len = slen - max_xmit;
	mov	r3,_packet_get_next_slen_1_1
	mov	dptr,#_last_sent_len
	mov	a,r3
	clr	c
	subb	a,r7
...
;	radio/packet.c:205: slen = encryptReturn(buf, last_sent, max_xmit);
	...
	mov	r3,dpl
	pop	ar7
	mov	_packet_get_next_slen_1_1,r3
	mov	(_packet_get_next_slen_1_1 + 1),#0x00
...
;	radio/packet.c:209: return slen;
	mov	r4,_packet_get_next_slen_1_1
	mov	dpl,r4
	ret
00104$:
...
;	radio/packet.c:219: slen = serial_read_available();
	push	ar7
	lcall	_serial_read_available
	mov	_packet_get_next_slen_1_1,dpl
	mov	(_packet_get_next_slen_1_1 + 1),dph
	pop	ar7
...
;	radio/packet.c:234: slen = max_xmit;
	mov	_packet_get_next_slen_1_1,r5
	mov	(_packet_get_next_slen_1_1 + 1),r6
00112$:
...
;	radio/packet.c:239: if (slen == 0) {
	mov	a,_packet_get_next_slen_1_1
	orl	a,(_packet_get_next_slen_1_1 + 1)
...
;	radio/packet.c:257: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_1,00198$
	clr	a
	cjne	a,(_packet_get_next_slen_1_1 + 1),00198$
	sjmp	00199$
00198$:
	sjmp	00123$
00199$:
...
;	radio/packet.c:274: if (slen < mav_pkt_len) {
	...
	mov	a,_packet_get_next_slen_1_1
	subb	a,r5
	mov	a,(_packet_get_next_slen_1_1 + 1)
	subb	a,r6
	jnc	00129$
...
;	radio/packet.c:294: register uint8_t c = serial_peekx(0);
	...
	push	ar7
	lcall	_serial_peekx
	mov	_packet_get_next_c_2_17,dpl
	pop	ar7
;	radio/packet.c:295: if (c == MAVLINK10_STX || c == MAVLINK20_STX) {
	mov	a,#0xFE
	cjne	a,_packet_get_next_c_2_17,00205$
	sjmp	00150$
00205$:
	mov	a,#0xFD
	cjne	a,_packet_get_next_c_2_17,00206$
	sjmp	00207$
00206$:
	ljmp	00151$
00207$:
...
;	radio/packet.c:296: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_1,00208$
	clr	a
	cjne	a,(_packet_get_next_slen_1_1 + 1),00208$
	sjmp	00209$
00208$:
	sjmp	00135$
00209$:
...
;	radio/packet.c:314: slen--;				
	dec	_packet_get_next_slen_1_1
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_1,00214$
	dec	(_packet_get_next_slen_1_1 + 1)
00214$:
...
;	radio/packet.c:321: if (c == MAVLINK20_STX) {
	mov	a,#0xFD
	cjne	a,_packet_get_next_c_2_17,00143$
...
;	radio/packet.c:350: slen--;
	dec	_packet_get_next_slen_1_1
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_1,00221$
	dec	(_packet_get_next_slen_1_1 + 1)
00221$:
	ljmp	00154$
00156$:
...
;------------------------------------------------------------
;max                       Allocated with name '_packet_set_max_xmit_max_1_1'
;------------------------------------------------------------
...
;	radio/packet.c:383: mav_max_xmit = max;
	mov	dptr,#_packet_set_max_xmit_max_1_1
	movx	@dptr,a
	mov	r0,#_mav_max_xmit
	movx	@r0,a
	ret
...
;------------------------------------------------------------
;speed                     Allocated with name '_packet_set_serial_speed_speed_1_1'
;------------------------------------------------------------
...
_packet_set_serial_speed:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_packet_set_serial_speed_speed_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
...
;len                       Allocated with name '_packet_is_duplicate_len_1_1'
;------------------------------------------------------------
...
_packet_is_duplicate:
	mov	a,dpl
	mov	dptr,#_packet_is_duplicate_len_1_1
	movx	@dptr,a
...
;------------------------------------------------------------
;buf                       Allocated with name '_packet_inject_buf_1_1'
;------------------------------------------------------------
...
_packet_inject:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_packet_inject_buf_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
